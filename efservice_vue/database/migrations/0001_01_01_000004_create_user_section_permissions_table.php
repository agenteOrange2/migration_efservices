...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_section_permissions', function (Blueprint $table) {
            ...
            $table->string('section'); // Sección específica (ejemplo: 'dashboard', 'drivers', etc.)
            $table->boolean('can_access')->default(false); // Indica si el usuario puede acceder a la sección
            $table->timestamps();
        });
    }
