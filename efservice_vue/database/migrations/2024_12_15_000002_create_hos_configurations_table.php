...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('hos_configurations', function (Blueprint $table) {
            ...
            $table->boolean('allow_24_hour_reset')->default(true); // For construction/oilfield
            // Break requirements
            $table->boolean('require_30_min_break')->default(true);
            $table->integer('break_after_hours')->default(8); // After 8h driving
            // Weekly cycle limits
            $table->integer('weekly_limit_60_minutes')->default(3600); // 60h
            $table->integer('weekly_limit_70_minutes')->default(4200); // 70h
            // Ghost log detection
