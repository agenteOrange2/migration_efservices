...
class Constants
{
    ...
    public static function equipmentTypes(): array
    {
        return [
            ...
            'Tractor Trailer (18 Wheeler)'    => 'Tractor Trailer (18 Wheeler)',
            'Tractor Trailer (Flat Bed)'      => 'Tractor Trailer (Flat Bed)',
            'Tractor Trailer (Refrigerator)'  => 'Tractor Trailer (Refrigerator)',
