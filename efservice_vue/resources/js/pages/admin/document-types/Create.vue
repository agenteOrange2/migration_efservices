...
<template>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Create Document Type</h1>
                <p class="text-sm text-slate-500">Add a new document type for carrier compliance</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit">
            <div class="box box--stacked p-6 space-y-5">
                <div>
                    ...
                    <FormInput v-model="form.name" type="text" placeholder="e.g. DOT Certificate" />
                ...
                <div>
                    ...
                    <div v-if="form.errors.requirement" class="text-red-500 text-xs mt-1">{{ form.errors.requirement }}</div>
                </div>
                ...
                <div v-if="form.allow_default_file === '1'" class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                    <FormLabel>Upload Default File</FormLabel>
            ...
            <div class="flex justify-end gap-3 mt-5">
                ...
                <Button type="submit" variant="primary" :disabled="form.processing" class="px-6">
                    <Lucide icon="Save" class="w-4 h-4 mr-2" /> Save Document Type
                </Button>
            </div>
        </form>
    </div>
