                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody>
                            <tr v-for="accident in accidents.data" :key="accident.id" class="border-b border-slate-100 hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-5 py-4 text-sm text-info">{{ accident.document_count }}</td>
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <Link :href="route('admin.accidents.edit', accident.id)" class="p-1.5 text-slate-400 hover:text-warning transition">
