...
function badge(value: string | null | undefined) {
    ...
    if (['archived', 'active', 'valid', 'verified', 'completed', 'qualified', 'certified', 'passed', 'negative'].includes(v)) return 'bg-emerald-100 text-emerald-700'
    if (['expired', 'failed', 'termination', 'positive', 'refused', 'disqualified'].includes(v)) return 'bg-red-100 text-red-600'
