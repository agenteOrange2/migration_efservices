...
function removeRecipient(recipient: RecipientRow) {
    ...
    router.delete(route('admin.messages.remove-recipient', [props.message.id, recipient.id]), {
        preserveScroll: true,
    })
}
</script>
...
<template>
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 xl:col-span-8">
            <Form :mode="'edit'" :form="form" :drivers="drivers" :carriers="carriers" />
        </div>
