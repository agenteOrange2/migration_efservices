...
function duplicateMessage() {
    ...
    router.post(route('admin.messages.duplicate', props.message.id), {}, { preserveScroll: true })
}

function resendMessage() {
    if (!confirm(`Resend "${props.message.subject}" to all recipients?`)) return
    router.post(route('admin.messages.resend', props.message.id), {}, { preserveScroll: true })
}

function deleteMessage() {
    if (!confirm(`Delete "${props.message.subject}"? This cannot be undone.`)) return
    router.delete(route('admin.messages.destroy', props.message.id), { preserveScroll: true })
}
</script>
            ...
            <div class="box box--stacked p-6">
                <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <Link v-if="message.can_edit" :href="route('admin.messages.edit', message.id)">
