...
function submit() {
    form.post(
        route('admin.driver-types.store-vehicle-assignment', props.driver.id),
    );
}
</script>
    ...
    <div class="grid grid-cols-12 gap-x-6 gap-y-8">
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Create the initial active assignment for this driver.
                    </p>
                </div>
        ...
        <div class="col-span-12 xl:col-span-7">
            <div class="box box--stacked p-6">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Only currently available vehicles are shown here.
                </p>
                ...
                <div class="mt-5 grid grid-cols-1 gap-5">
                    ...
                    <div>
                        ...
                        />
                        <p
                            v-if="form.errors.assignment_date"
                            class="mt-1 text-xs text-red-500"
                        >
                            {{ form.errors.assignment_date }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <FormTextarea
                            v-model="form.notes"
                            rows="5"
                            placeholder="Add any dispatch, onboarding, or unit notes..."
                        />
                        <p
        ...
        <div class="col-span-12 xl:col-span-5">
            <div class="box box--stacked p-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            {{ availableVehicles.length }} unit(s) ready to
                            assign.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-5 space-y-3">
                    ...
                    >
                        There are no available vehicles right now. Free one from
                        another driver or create a new vehicle first.
                    </div>
                </div>
            </div>
        </div>
