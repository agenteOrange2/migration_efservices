    ...
    <div class="grid grid-cols-12 gap-x-6 gap-y-8">
        <div class="col-span-12">
            <div class="box box--stacked p-6">
                ...
                >
                    ...
                    <div
                        class="rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/80 px-5 py-4"
                    >
                        <div
            ...
            <div class="box box--stacked p-5">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-5">
                    ...
                    <TomSelect v-model="filters.assignment_status">
                        ...
                        <option
                            v-for="(label, key) in assignmentStatusOptions"
                            :key="key"
                            :value="key"
                        >
                            {{ label }}
                ...
                <div class="mt-4 flex flex-wrap items-center gap-3">
                    <button
                        type="button"
                        class="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-white transition hover:bg-primary/90"
                        @click="applyFilters"
                    >
                    ...
                    <button
                        type="button"
                        class="inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-slate-600 transition hover:bg-slate-50"
                        @click="resetFilters"
                    >
        ...
        <div class="col-span-12">
            <div class="box box--stacked overflow-hidden">
                            ...
                            >
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl border border-primary/15 bg-primary/5"
                                        >
                                            <img
                                ...
                                <td class="px-5 py-4">
                                    <div
                                        v-if="driver.assignment"
                                        class="font-medium text-slate-800"
                                    >
                                        {{
                                            driver.assignment.driver_type_label
                                        }}
                                    </div>
                                ...
                                <td class="px-5 py-4">
                                    <template v-if="driver.assignment?.vehicle">
                                        <div class="font-medium text-slate-800">
                                            {{ driver.assignment.vehicle.unit }}
                                        </div>
                                        <div
                                            class="mt-1 text-xs text-slate-500"
                                        >
                                            {{
                                                driver.assignment.vehicle.title
                                            }}
                                        </div>
                                        <div
                                            v-if="driver.assignment.vehicle.vin"
                                            class="mt-1 text-xs text-slate-400"
                                        >
                                            VIN
                                            {{ driver.assignment.vehicle.vin }}
                                        </div>
                                    </template>
                                    <span v-else class="text-slate-400"
                                        >No vehicle assigned</span
                                    >
                                </td>
                                <td class="px-5 py-4">
                                    <div
                                    ...
                                    <div
                                        v-else
                                        class="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold tracking-wide text-slate-500 uppercase"
                                    >
                                        Unassigned
                                    </div>
                                </td>
                ...
                <div
                    class="flex flex-wrap items-center justify-end gap-2 border-t border-slate-200/70 px-5 py-4"
                >
                    <Link
