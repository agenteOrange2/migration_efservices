...
const form = useForm({
    ...
    start_date:
        props.currentAssignment.start_date ??
...
function submit() {
    form.put(route('admin.driver-types.update-assignment', props.driver.id));
}
</script>
    ...
    <div class="grid grid-cols-12 gap-x-6 gap-y-8">
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Update the vehicle, driver type, and third-party context
                        when needed.
                    </p>
                </div>
            ...
            <div class="box box--stacked p-6">
                ...
                >
                    ...
                    >
                        ...
                        >
                            {{ currentAssignment.vehicle?.unit || 'N/A' }}
                        </div>
                        <div class="mt-1 text-xs text-slate-500">
                            {{ currentAssignment.vehicle?.title || 'N/A' }}
                        </div>
                    </div>
                    <div
                        class="rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/70 p-4"
                    >
                        ...
                        <div
                            class="mt-1 text-base font-semibold text-slate-800"
                        >
                            {{ currentAssignment.driver_type_label }}
                        </div>
                    </div>
                    <div
                        class="rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/70 p-4"
                    >
                        ...
                        <div
                            class="mt-1 text-base font-semibold text-slate-800"
                        >
                            {{ currentAssignment.start_date || 'N/A' }}
                        </div>
                    </div>
                    <div
                        class="rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/70 p-4"
        ...
        <div class="col-span-12">
            <div class="box box--stacked p-6">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Saving will close the current assignment and register a
                    fresh active one.
                </p>
                ...
                <div class="mt-5 grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <TomSelect v-model="form.driver_type">
                            ...
                            <option
                                v-for="(label, key) in driverTypeOptions"
                                :key="key"
                                :value="key"
                            >
                                {{ label }}
                    ...
                    <div
                        v-if="isThirdParty"
                        class="rounded-2xl border border-primary/15 bg-primary/5 p-5 md:col-span-2"
                    >
                        ...
                        >
                            <div>
                                ...
                                >
                                <FormInput
                                    v-model="form.third_party_name"
                                    type="text"
                                    placeholder="Enter company name"
                                />
                                <p
                                    v-if="form.errors.third_party_name"
                                    class="mt-1 text-xs text-red-500"
                                >
                                    {{ form.errors.third_party_name }}
                                </p>
                            </div>
                            <div>
                                <label
                            ...
                            <div>
                                ...
                                >
                                <FormInput
                                    v-model="form.third_party_contact"
                                    type="text"
                            ...
                            <div class="md:col-span-2 xl:col-span-3">
                                ...
                                >
                                <FormInput
                                    v-model="form.third_party_address"
                                    type="text"
                                    placeholder="Complete address"
                                />
                                <p
                                    v-if="form.errors.third_party_address"
                                    class="mt-1 text-xs text-red-500"
                                >
                                    {{ form.errors.third_party_address }}
                                </p>
                            </div>
                            <div>
                                <label
                                ...
                                >
                                <FormInput
                                    v-model="form.third_party_phone"
                                    type="text"
                                    placeholder="Phone number"
                                />
                                <p
                                    v-if="form.errors.third_party_phone"
                                    class="mt-1 text-xs text-red-500"
                                >
                                    {{ form.errors.third_party_phone }}
                                </p>
                            </div>
                            <div>
                                <label
                                ...
                                >
                                <FormInput
                                    v-model="form.third_party_email"
                                    type="email"
                                    placeholder="Email address"
                                />
                                <p
                                    v-if="form.errors.third_party_email"
                                    class="mt-1 text-xs text-red-500"
                                >
                                    {{ form.errors.third_party_email }}
                                </p>
                            </div>
                            <div>
                                <label
                    ...
                    <div class="md:col-span-2">
                        ...
                        <FormTextarea
                            v-model="form.notes"
                            rows="5"
                            placeholder="Add any details about this reassignment..."
                        />
                        <p
