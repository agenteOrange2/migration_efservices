            ...
            <div class="box box--stacked p-6">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-slate-800">Add New License</h1>
                            <p class="text-slate-500">Create a driver license record in the new Vue admin.</p>
                        </div>
                    </div>
            ...
            <div class="box box--stacked p-5 sticky top-4">
                ...
                <div class="space-y-3 text-sm text-slate-600">
                    <div class="rounded-lg bg-slate-50 p-3">
                        Pick a carrier first so the driver list stays scoped correctly.
                    </div>
                    <div class="rounded-lg bg-slate-50 p-3">
