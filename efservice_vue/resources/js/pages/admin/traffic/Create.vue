...
withDefaults(defineProps<{
    ...
    routeNames: () => ({
        ...
        driverHistory: 'admin.traffic.driver-history',
        documentsShow: 'admin.traffic.documents.show',
        mediaDestroy: 'admin.traffic.media.destroy',
...
<template>
    <Head title="Add Traffic Conviction" />
    <Form mode="create" :carriers="carriers" :drivers="drivers" :carrier="carrier" :is-carrier-context="isCarrierContext" :route-names="routeNames" />
</template>
