...
function applyFilters() {
    router.get(route('carrier.notifications.index'), {
...
function markAsRead(notification: NotificationItem) {
    router.post(route('carrier.notifications.mark-as-read', notification.id), {}, {
        preserveScroll: true,
    })
}

function markAsUnread(notification: NotificationItem) {
    router.post(route('carrier.notifications.mark-as-unread', notification.id), {}, {
        preserveScroll: true,
    })
}

function markAllAsRead() {
    router.post(route('carrier.notifications.mark-all-read'), {}, {
        preserveScroll: true,
    })
}
...
function deleteNotification(notification: NotificationItem) {
    ...
    router.delete(route('carrier.notifications.destroy', notification.id), {
        preserveScroll: true,
    })
}
...
function deleteFiltered() {
    ...
    router.visit(route('carrier.notifications.delete-all'), {
        method: 'delete',
        data: {
            search: filters.search || undefined,
            status: filters.status || undefined,
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Keep track of driver activity, expiring compliance items, and vehicle alerts from one place.</p>
                        </div>
                    </div>
