            ...
            <div class="relative z-10 flex flex-col justify-center w-full h-full py-2 lg:py-32">
                <div class="rounded-[0.8rem] w-[55px] h-[55px] border border-primary/30 flex items-center justify-center">
                    <div class="relative flex items-center justify-center w-[50px] rounded-[0.6rem] h-[50px] bg-linear-to-b from-theme-1/90 to-theme-2/90 bg-white">
                        <Lucide icon="CheckCircle" class="w-8 h-8 text-white" />
                    </div>
                </div>

                <div class="mt-10">
                    <div class="text-2xl font-medium">Registration Completed!</div>
                    <div class="mt-2.5 text-slate-600">
                        Your registration has been submitted for review. You can upload your documents later from the dashboard.
                    </div>
                    ...
                    <!-- Success Message -->
                    <div class="mt-6 rounded-[0.6rem] bg-green-50 p-4">
                        <div class="flex items-center gap-2">
                            <Lucide icon="CheckCircle" class="w-5 h-5 text-green-600 shrink-0" />
                            <p class="text-sm font-medium text-green-800">All registration steps completed successfully!</p>
                        </div>
                    </div>
        ...
        <div :class="[
            ...
            <div class="sticky top-0 z-10 flex-col justify-center hidden h-screen ml-16 lg:flex xl:ml-28 2xl:ml-36">
                ...
                <div class="mt-5 text-base leading-relaxed xl:text-lg text-white/70">
                    Your carrier registration is complete. Our team will review your information shortly.
                </div>
            </div>
        </div>
    </div>
