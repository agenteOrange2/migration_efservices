...
<template>
  <div :class="[
    'raze',
    'before:content-[\'\'] before:bg-linear-to-b before:from-slate-100 before:to-slate-50 before:h-screen before:w-full before:fixed before:top-0',
  ]">
    <div :class="[
      ...
      <div :class="[
        ...
        <div
          ...
          <a href=""
            ...
            <div
              class="flex items-center justify-center w-[34px] rounded-lg h-[34px] bg-white/[0.08] transition-transform ease-in-out group-[.side-menu--collapsed.side-menu--on-hover]:xl:-rotate-180">
              <div class="w-[16px] h-[16px] relative -rotate-45 [&_div]:bg-white">
                <div class="absolute w-[21%] left-0 inset-y-0 my-auto rounded-full opacity-50 h-[75%]"></div>
                <div class="absolute w-[21%] inset-0 m-auto h-[120%] rounded-full"></div>
                <div class="absolute w-[21%] right-0 inset-y-0 my-auto rounded-full opacity-50 h-[75%]"></div>
              </div>
            </div>
            <div
            ...
            <div class="flex items-center flex-1">
              ...
              <Menu class="ml-5">
                <Menu.Button
                  ...
                  <img alt="Tailwise - Admin Dashboard Template" :src="users.fakeUsers()[0].photo" />
                </Menu.Button>
