...
class DriverMedicalStep extends Component
{
    use WithFileUploads;
    ...
    // Save medical information to create record and enable medical card upload
    public function saveMedicalInfo()
    {
        try {
            ...
            session()->flash('success', 'Medical information saved. You can now upload the Medical Card.');
