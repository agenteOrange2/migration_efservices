...
class DriverTwicExpiringNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject($urgency . 'Driver TWIC Card Expiring: ' . $driverName)
            ->greeting('Hello,')
            ->line('A driver\'s TWIC card is expiring soon and requires attention.')
            ...
            ->line('Please ensure the driver renews their TWIC card before expiration.');
    }
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'title' => 'Driver TWIC Card Expiring',
            'message' => $driverName . '\'s TWIC card expires in ' . $this->daysRemaining . ' days.',
            'type' => 'driver_twic_expiring',
            'category' => 'drivers',
            'icon' => 'IdCard',
