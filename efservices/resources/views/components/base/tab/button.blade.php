...
@if (substr($as, 0, 2) == 'x-')
    <x-dynamic-component
        ...
        {{ $attributes->class(
                merge([
                    !$unstyled
                        ? 'cursor-pointer block appearance-none px-3 py-2 border border-transparent text-slate-600 transition-colors'
                        : null,
                    ...
                    // Boxed tabs
                    !$unstyled && $variant == 'boxed-tabs' ? 'rounded-md py-1.5' : null,
