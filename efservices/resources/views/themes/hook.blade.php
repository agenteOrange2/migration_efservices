...
@section('content')
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                'content relative transition-[margin,width] duration-100 px-5 pt-[66px] pb-16',
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/hook.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/hook.js')
@endPushOnce
