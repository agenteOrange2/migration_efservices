...
@section('content')
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                ...
                <div class="fixed inset-x-0 top-0 z-10 flex h-[65px] bg-gradient-to-r from-theme-1 to-theme-2 shadow-lg">
                    <div @class([
                        ...
                        <a
                            class="hidden items-center transition-[margin] xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0 group-[.side-menu--collapsed]:xl:ml-8"
                            href=""
                        >
                            <div
            ...
            <div @class([
                'content transition-[margin,width] duration-100 pl-5 xl:pl-10 pr-5 mt-[65px] pt-[31px] pb-16 relative z-10',
                'content--compact',
                'xl:ml-[275px]',
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/havoc.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/havoc.js')
@endPushOnce
