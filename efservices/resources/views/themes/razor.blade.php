...
@section('content')
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                ...
                <div @class([
                    ...
                    <div @class([
                        ...
                        <a
                            class="flex items-center transition-[margin] duration-300 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0 group-[.side-menu--collapsed]:xl:ml-4"
                            href=""
                        >
                            <div
                ...
                <div @class([
                    ...
                    <div
                        ...
                        <div class="flex h-full w-full items-center px-5 transition-[padding] duration-300 ease-in-out">
                            ...
                            <div class="flex flex-1 items-center">
                                <div class="ml-auto flex items-center gap-1">
                                    ...
                                    <a
                                        class="request-full-screen rounded-full p-2 hover:bg-slate-100"
                                        href="javascript:;"
                                    >
                                        <x-base.lucide
                                            class="h-[18px] w-[18px]"
            ...
            <div @class([
                'content transition-[margin,width] duration-100 xl:pl-3.5 pt-[65px] pb-16 relative z-10',
                'content--compact',
                'xl:ml-[275px]',
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/razor.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/razor.js')
@endPushOnce
