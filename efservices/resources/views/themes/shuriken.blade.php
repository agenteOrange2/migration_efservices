        ...
        <div @class([
            ...
            <div @class([
                ...
                <div @class([
                    ...
                    <div
                        class="relative z-10 mt-2 hidden h-[65px] w-[275px] flex-none items-center overflow-hidden px-5 duration-300 xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed]:xl:w-[91px]">
                        <a
                ...
                <div @class([
                    ...
                    <div @class(['top-bar absolute inset-x-0 h-full mx-5 group'])>
                        <div
                            class="box group-[.top-bar--active]:box container flex h-full w-full items-center border-transparent bg-transparent shadow-none transition-[padding,background-color,border-color] duration-300 ease-in-out group-[.top-bar--active]:px-5">
                            <div class="flex items-center gap-1 xl:hidden">
                                <a
                                    class="open-mobile-menu rounded-full p-2 hover:bg-slate-100"
                                    href=""
                                >
                                    <x-base.lucide
                                        class="h-[18px] w-[18px]"
                            ...
                            >
                                <div
                                    class="box flex w-[350px] cursor-pointer items-center px-3.5 py-2 text-slate-400 transition-colors hover:bg-white/60 group-[.top-bar--active]:bg-slate-50 group-[.top-bar--active]:shadow-none group-[.top-bar--active]:hover:bg-slate-100">
                                    <x-base.lucide
                                        class="h-[18px] w-[18px]"
                                        icon="Search"
                                    />
                            ...
                            <div class="flex flex-1 items-center">
                                <div class="ml-auto flex items-center gap-1">
                                    ...
                                    <a
                                        class="request-full-screen rounded-full p-2 hover:bg-slate-200/50 group-[.top-bar--active]:hover:bg-slate-50"
                                        href="javascript:;"
                                    >
                                        <x-base.lucide
                                            class="h-[18px] w-[18px]"
            ...
            <div @class([
                'content transition-[margin,width] duration-100 px-5 pt-[39px] pb-16',
                'content--compact',
                'xl:ml-[275px]',
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/shuriken.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/shuriken.js')
@endPushOnce
