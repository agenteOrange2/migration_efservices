    ...
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                ...
                <div
                    class="box fixed inset-x-0 top-0 z-10 flex h-[65px] rounded-none border-x-0 border-t-0 bg-slate-50 shadow-none">
                    <div @class([
                        'side-menu__content',
                        ...
                        <div class="flex items-center gap-1 xl:hidden">
                            <a
                                class="p-2 rounded-full open-mobile-menu hover:bg-slate-100"
                                href=""
                            >
                                <x-base.lucide
                                    class="h-[18px] w-[18px]"
                    ...
                    <div
                        ...
                        <div class="flex items-center w-full h-full px-5">
                            <!-- BEGIN: Breadcrumb -->
                            <x-base.breadcrumb class="flex-1 hidden xl:block">
                            ...
                            >
                                <div
                                    class="flex w-[350px] cursor-pointer items-center rounded-[0.5rem] border bg-slate-100 px-3.5 py-2 text-slate-400 transition-colors hover:bg-slate-50">
                                    <x-base.lucide
                                        class="h-[18px] w-[18px]"
                                        icon="Search"
                                    />
                            ...
                            <div class="flex items-center flex-1">
                                <div class="flex items-center gap-1 ml-auto">
                                    ...
                                    <a
                                        class="p-2 rounded-full request-full-screen hover:bg-slate-100"
                                        href="javascript:;"
                                    >
                                        <x-base.lucide
                                            class="h-[18px] w-[18px]"
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/viper.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/viper.js')
@endPushOnce
