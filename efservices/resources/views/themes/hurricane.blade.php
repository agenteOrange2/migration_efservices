...
@section('content')
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                ...
                <div @class([
                    ...
                    <div @class([
                        ...
                        <a
                            class="ml-2.5 hidden items-center transition-[margin] xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-2.5 group-[.side-menu--collapsed]:xl:ml-6"
                            href=""
                        >
                            <div
                ...
                <div @class([
                    ...
                    <div @class([
                        'scrollable-ref w-full h-full z-20 px-5 mt-3.5 overflow-y-auto overflow-x-hidden pb-3 [-webkit-mask-image:-webkit-linear-gradient(top,rgba(0,0,0,0),black_30px)] [&:-webkit-scrollbar]:w-0 [&:-webkit-scrollbar]:bg-transparent',
            ...
            <div @class([
                'content transition-[margin,width] duration-100 px-5 xl:mr-2.5 mt-[75px] pt-[31px] pb-16',
                'content--compact',
                'xl:ml-[275px]',
                '[&.content--compact]:xl:ml-[100px]',
            ])>
                <div class="container">
                    @yield('subcontent')
                </div>
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/hurricane.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/hurricane.js')
@endPushOnce
