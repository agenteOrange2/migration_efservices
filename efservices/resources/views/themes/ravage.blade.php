...
@section('content')
    <div class="ravage min-h-screen bg-slate-100">
        <div @class([
            ...
            <div @class([
                'content transition-[margin,width] duration-100 px-5 pt-[56px] pb-16 z-10 relative',
                'content--compact',
                'xl:ml-[275px]',
...
@pushOnce('styles')
    ...
    @vite('resources/css/themes/ravage.css')
@endPushOnce
...
@pushOnce('scripts')
    @vite('resources/js/themes/ravage.js')
@endPushOnce
