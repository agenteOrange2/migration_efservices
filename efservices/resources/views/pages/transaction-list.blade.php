                ...
                <div class="box box--stacked flex flex-col">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <x-base.form-select class="mt-2 flex-1">
                                                @foreach ($transactionStatus as $fakerKey => $faker)
                                                    <option value="{{ $fakerKey }}">
                                                        {{ $faker['name'] }}
                                                    </option>
                                                @endforeach
                    ...
                    <div class="overflow-auto xl:overflow-visible">
                        <x-base.table class="border-b border-slate-200/60">
                            ...
                            <x-base.table.tbody>
                                @foreach ($transactions->take(10) as $fakerKey => $faker)
                                    <x-base.table.tr class="[&_td]:last:border-b-0">
                                        <x-base.table.td class="border-dashed py-4">
                                            <x-base.form-check.input type="checkbox" />
                                        </x-base.table.td>
                                        <x-base.table.td class="w-44 border-dashed py-4">
