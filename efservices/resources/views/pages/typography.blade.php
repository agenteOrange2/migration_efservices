                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <h2
                                                    class="mt-3 text-3xl font-medium leading-none text-slate-600">
                                                    h2. Heading 2
                                                </h2>
                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span
                                                    class="mr-1 rounded-full border px-1 text-xs text-slate-600"
                                                >
                                                    2
                                                </span>
                                                ...
                                                <span
                                                    class="mr-1 rounded-full bg-slate-100 px-1 text-xs text-slate-500"
                                                >
                                                    6
                                                </span>
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <span
                                                    class="mr-1 rounded-full border px-2 py-1 text-slate-600"
                                                >
                                                    2
                                                </span>
                                                ...
                                                <span
                                                    class="mr-1 rounded-full bg-slate-100 px-2 py-1 text-slate-500"
                                                >
                                                    6
                                                </span>
                                            </div>
                                            <div class="mt-4">
                                                ...
                                                <span
                                                    class="mr-1 rounded-full border px-3 py-2 text-slate-600"
                                                >
                                                    2
                                                </span>
                                                ...
                                                <span
                                                    class="mr-1 rounded-full bg-slate-100 px-3 py-2 text-slate-500"
                                                >
                                                    6
                                                </span>
                                            </div>
                                            <div class="mt-6">
                                                ...
                                                <span
                                                    class="mr-1 rounded-full border px-4 py-3 text-slate-600"
                                                >
                                                    2
                                                </span>
                                                ...
                                                <span
                                                    class="mr-1 rounded-full bg-slate-100 px-4 py-3 text-slate-500"
                                                >
                                                    6
                                                </span>
                                            </div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span
                                                    class="mr-1 border px-1 text-xs text-slate-600"
                                                >
                                                    2
                                                </span>
                                                ...
                                                <span
                                                    class="mr-1 bg-slate-100 px-1 text-xs text-slate-500"
                                                >
                                                    6
                                                </span>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <span
                                                    class="mr-1 rounded-full border border-primary px-3 py-2 text-primary"
                                                >
                                                    1
                                                </span>
                                                <span
                                                ...
                                                <span
                                                    class="mr-1 rounded-full border border-success px-3 py-2 text-success"
                                                >
                                                    3
                                                </span>
                                                <span
                                                    class="mr-1 rounded-full border border-warning px-3 py-2 text-warning"
                                                >
                                                    4
                                                </span>
                                                <span
                                                    class="mr-1 rounded-full border border-danger px-3 py-2 text-danger"
                                                >
                                                    5
                                                </span>
                                            </div>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            <div
                                                class="w-full border-t border-dashed border-slate-200/60">
                                            </div>
                                            <div class="mt-5 w-full border-t border-slate-200/60">
                                            </div>
                                        </x-base.preview>
                                        <x-base.source>
                                            <x-base.highlight>
                                                ...
                                                <div
                                                    class="mt-5 w-full border-t border-slate-200/60">
                                                </div>
                                            </x-base.highlight>
                                        </x-base.source>
                                    </div>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            <div
                                                class="mt-2 flex w-full justify-center border-t border-slate-200/60">
                                                <div class="-mt-3 bg-white px-5 text-slate-500">
                                                    or
                                                </div>
                                            </div>
                                        </x-base.preview>
