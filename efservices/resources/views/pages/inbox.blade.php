                            ...
                            <div>
                                <div
                                    ...
                                    @foreach ($mails->take(13) as $fakerKey => $faker)
                                        <div @class([
                                            'transition duration-200 ease-in-out transform cursor-pointer inline-block sm:block last:border-b-0 border-b border-slate-200/50',
                                            'hover:relative hover:bg-slate-50',
                                            'bg-primary/[0.03] text-slate-500' => !$faker[
                                                'opened'
                                            ],
                                            'dark:text-slate-300' => $faker['opened'],
                                        ])>
