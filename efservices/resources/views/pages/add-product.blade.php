            ...
            <div class="mt-3.5 grid grid-cols-12 gap-x-6 gap-y-7 lg:gap-y-10 xl:grid-cols-10">
                <div class="relative flex flex-col col-span-12 gap-y-7 lg:col-span-9 xl:col-span-8">
                    <div class="flex flex-col p-5 box box--stacked">
                        <div class="rounded-[0.6rem] border border-slate-200/60 p-5">
                            <div
                                class="flex items-center border-b border-slate-200/60 pb-5 text-[0.94rem] font-medium">
                                <x-base.lucide
                    ...
                    <div class="flex flex-col p-5 box box--stacked">
                        <div class="rounded-[0.6rem] border border-slate-200/80 p-5">
                            <div
                                class="flex items-center border-b border-slate-200/80 pb-5 text-[0.94rem] font-medium">
                                <x-base.lucide
                                    class="mr-2 h-5 w-5 stroke-[1.3]"
                                    icon="ChevronDown"
                                />
                        ...
                        <div class="rounded-[0.6rem] border border-slate-200/60 p-5">
                            ...
                            <div class="mt-5">
                                <div
                                    ...
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <div
                                            class="relative py-10 pl-5 pr-5 border rounded-md border-slate-200/80 bg-slate-50/80 xl:pr-10">
                                            <a
                                        ...
                                        <div class="overflow-x-auto">
                                            <x-base.table class="border">
                                                <x-base.table.thead>
                                                    <x-base.table.tr>
                                                        <x-base.table.th
                                                            class="whitespace-nowrap bg-slate-50 text-slate-500"
                                                        >
                                                            Size
                                                        </x-base.table.th>
                                                        <x-base.table.th
                                                        ...
                                                        <x-base.table.th
                                                            class="whitespace-nowrap bg-slate-50 !px-2 text-slate-500"
                                                        >
                                                            Price
                                                        </x-base.table.th>
                                                        <x-base.table.th
                                                        ...
                                                        <x-base.table.th
                                                            class="whitespace-nowrap bg-slate-50 !pl-2 text-slate-500"
                                                        >
                                                            Variant Code
                                                        </x-base.table.th>
                                                    </x-base.table.tr>
                                        ...
                                        <div class="overflow-x-auto">
                                            <x-base.table class="border">
                                                <x-base.table.thead>
                                                    <x-base.table.tr>
                                                        <x-base.table.th
                                                            class="bg-slate-50 !pr-2"></x-base.table.th>
                                                        <x-base.table.th
                                                            class="bg-slate-50"></x-base.table.th>
                                                        <x-base.table.th
                                                            class="whitespace-nowrap bg-slate-50 !px-2 text-slate-500"
                                                        >
                                                            Min.
                                                        ...
                                                        <x-base.table.th
                                                            class="bg-slate-50 !px-2"></x-base.table.th>
                                                    </x-base.table.tr>
                                                </x-base.table.thead>
                                                <x-base.table.tbody>
                                                    <x-base.table.tr>
                ...
                <div class="relative order-first col-span-12 lg:order-last lg:col-span-3 xl:col-span-2">
                    <div class="sticky top-[104px]">
                        ...
                        <div
                            class="relative mt-7 rounded-[0.6rem] border border-warning/[0.15] bg-warning/[0.07] p-5">
                            <x-base.lucide
                            ...
                            <div class="mt-2 text-xs leading-relaxed text-slate-600/90">
                                <div>
