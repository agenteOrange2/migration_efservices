            ...
            <div class="mt-3.5 grid grid-cols-12 gap-5">
                ...
                <div class="flex flex-col col-span-12 p-5 box box--stacked md:col-span-6 2xl:col-span-3">
                    <x-base.menu class="absolute top-0 right-0 mt-5 mr-5">
                        ...
                        <x-base.menu.items class="w-40">
                            <x-base.menu.item>
                                <x-base.lucide class="w-4 h-4 mr-2" icon="Copy" /> Copy Link
                            </x-base.menu.item>
                            <x-base.menu.item>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <x-base.lucide class="w-6 h-6 fill-primary/10 text-primary" icon="Database" />
                        </div>
                        <div class="ml-4">
                    ...
                    <div class="relative mt-5 mb-6 overflow-hidden">
                        ...
                        <x-report-line-chart class="relative z-10 -ml-1.5" data-index="2" data-border-color="primary"
                            data-background-color="primary/0.3" height="h-[100px]" />
                    </div>
                ...
                <div class="flex flex-col col-span-12 p-5 box box--stacked md:col-span-6 2xl:col-span-3">
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <x-base.lucide class="w-6 h-6 fill-success/10 text-success" icon="Files" />
                        </div>
                        <div class="ml-4">
                    ...
                    <div class="relative mt-5 mb-6 overflow-hidden">
                        ...
                        <x-report-line-chart class="relative z-10 -ml-1.5" data-index="0" data-border-color="success"
                            data-background-color="success/0.3" height="h-[100px]" />
                    </div>
                    <div class="flex flex-wrap items-center justify-center gap-x-5 gap-y-3">
                        <div class="flex items-center">
                ...
                <div class="flex flex-col col-span-12 p-5 box box--stacked md:col-span-6 2xl:col-span-3">
                    ...
                    <div class="flex items-center">
                        <div
                            class="flex items-center justify-center w-12 h-12 border rounded-full border-primary/10 bg-primary/10">
                            <x-base.lucide class="w-6 h-6 fill-primary/10 text-primary" icon="Zap" />
                        </div>
                        <div class="ml-4">
                            <div class="text-base font-medium">
                    ...
                    <div class="relative mt-5 mb-6">
                        <x-report-donut-chart-3 class="relative z-10" height="h-[100px]" />
                    </div>
                    <div class="flex flex-wrap items-center justify-center gap-x-5 gap-y-3">
                        <div class="flex items-center">
                            <div class="w-2 h-2 rounded-full bg-primary/70"></div>
