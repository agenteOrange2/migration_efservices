        ...
        <div class="col-span-12">
            <x-base.tab.group>
                ...
                <x-base.tab.panels class="box box--stacked mt-3.5">
                    <x-base.tab.panel class="flex flex-col gap-2 p-1.5 leading-relaxed xl:flex-row" id="example-1" selected>
                        <div class="grid w-full grid-cols-4 gap-2">
                            <div
                                ...
                                <div
                                    ...
                                    <x-base.lucide class="h-6 w-6 fill-white/10 text-white" icon="Database" />
                                </div>
                                ...
                                <x-base.menu class="absolute right-0 top-0 mr-5 mt-5">
                                    <x-base.menu.button class="h-5 w-5 text-slate-500">
                                        <x-base.lucide class="h-6 w-6 fill-white/70 stroke-white/70" icon="MoreVertical" />
                                    </x-base.menu.button>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <x-base.lucide class="h-6 w-6 fill-primary/10 text-primary" icon="AppWindow" />
                                </div>
                                <div class="mt-12 flex items-center">
                                ...
                                <x-base.menu class="absolute right-0 top-0 mr-5 mt-5">
                                    <x-base.menu.button class="h-5 w-5 text-slate-500">
                                        <x-base.lucide class="h-6 w-6 fill-slate-400/70 stroke-slate-400/70"
                                            icon="MoreVertical" />
                                    </x-base.menu.button>
                                    <x-base.menu.items class="w-40">
                                        <x-base.menu.item>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <x-base.lucide class="h-6 w-6 fill-info/10 text-info" icon="Box" />
                                </div>
                                <div class="mt-12 flex items-center">
                            ...
                            <div
                                ...
                                <div
                                    class="flex h-12 w-12 items-center justify-center rounded-full border border-primary/10 bg-primary/10">
                                    <x-base.lucide class="h-6 w-6 fill-primary/10 text-primary" icon="Layout" />
                                </div>
                                <div class="mt-12 flex items-center">
                        ...
                        <a class="flex flex-col items-center justify-center rounded-[0.6rem] border border-dashed border-slate-300/80 bg-slate-50 p-5 text-slate-400/80 hover:bg-slate-50 xl:w-20 [&:hover_svg]:rotate-180"
                            href="">
                            <x-base.lucide class="h-6 w-6 transform transition-transform" icon="PlusSquare" />
                        </a>
                    </x-base.tab.panel>
                    <x-base.tab.panel class="p-5 leading-relaxed" id="example-2"></x-base.tab.panel>
                    <x-base.tab.panel class="p-5 leading-relaxed" id="example-3"></x-base.tab.panel>
                </x-base.tab.panels>
            </x-base.tab.group>
        </div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    <div
                        ...
                        <div class="image-fit h-14 w-14 overflow-hidden rounded-full border-[3px] border-slate-200/70">
                            <img src="{{ Vite::asset($users[0]['photo']) }}" alt="Tailwise - Admin Dashboard Template">
                        </div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    <div class="mb-5 border-b border-dashed border-slate-300/70 pb-5">
                        ...
                        <div class="relative mt-3">
                            <x-base.form-input class="sm:py-3" type="text" placeholder="everyone@gmail.com" />
                            <x-base.button
                                ...
                                <x-base.lucide class="mr-1.5 h-3.5 w-3.5 stroke-[1.3]" icon="Send" />
                                Send Invitation
                            </x-base.button>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center gap-3.5">
                                <div>
                                    <div
                                        ...
                                        <img src="{{ Vite::asset($faker['photo']) }}"
                                ...
                                <div class="flex w-full flex-col gap-y-2.5 sm:flex-row sm:items-center">
                                    ...
                                    <div class="relative sm:ml-auto">
                                        <x-base.lucide class="absolute inset-y-0 my-auto ml-2.5 h-3.5 w-3.5 stroke-[1.2]"
                                            icon="Settings" />
                                        <x-base.form-select
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex gap-3">
                            <x-base.form-input class="text-slate-500" type="text"
                                value="https://left4code.com/invitation?token=abcdefgh12345678"
                                placeholder="everyone@gmail.com" disabled />
                            <x-base.tippy content="Copy link" as="x-base.button" variant="outline-secondary">
                                <x-base.lucide class="h-4 w-4 stroke-[1.5]" icon="Copy" />
                            </x-base.tippy>
                        </div>
                    </div>
                </div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    <div class="mb-5 border-b border-dashed border-slate-300/70 pb-5">
                        ...
                        <div
                            ...
                            <x-base.lucide class="mr-2 h-5 w-5" icon="Clock" />
                        ...
                        <div class="mt-5 flex flex-col gap-4">
                            ...
                            <div class="flex flex-col items-center gap-y-2 sm:flex-row">
                                ...
                                <div class="flex h-5 items-center sm:ml-5">
                                    <div
                                        ...
                                        <img src="{{ Vite::asset($projects[0]['projectManager']['photo']) }}"
                                            alt="Tailwise - Admin Dashboard Template">
                                    </div>
                                    <div
                            ...
                            <div class="flex flex-col items-center gap-y-2 sm:flex-row">
                                ...
                                <div class="flex items-center sm:ml-5 sm:h-7">
                                    <div
                                        class="image-fit zoom-in box h-6 w-6 overflow-hidden rounded-full border-2 border-slate-200/70">
                                        <img src="{{ Vite::asset($projects[1]['projectManager']['photo']) }}"
                                            alt="Tailwise - Admin Dashboard Template">
                                    </div>
                                    <div
                                        class="ml-2.5 underline decoration-primary/30 decoration-dotted underline-offset-[3px]">
                    ...
                    <div>
                        <div
                            ...
                            <x-base.lucide class="mr-2 h-5 w-5 stroke-[1.3]" icon="KanbanSquare" />
                            Project Details for Team Members
                            <x-base.menu class="ml-auto">
                                <x-base.menu.button as="a">
                                    <x-base.lucide class="h-5 w-5 fill-slate-500/70 stroke-slate-500/70"
                                        icon="MoreVertical" />
                                </x-base.menu.button>
                                <x-base.menu.items class="w-40">
                                    <x-base.menu.item>
                            ...
                            @foreach ($projectDetails->take(4) as $fakerKey => $faker)
                                <div
                                    ...
                                    <div class="absolute right-0 top-0 mr-3 mt-3">
                                        <x-base.form-check.input class="border" type="checkbox"
                                    ...
                                    <div class="-mt-1">
                                        ...
                                        <div class="mt-2.5 flex items-center text-xs text-slate-500">
                                            <x-base.lucide class="mr-1.5 h-2.5 w-2.5 stroke-[2]" icon="Link" />
