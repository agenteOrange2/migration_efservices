                        ...
                        <x-base.preview-component>
                            <div
                                ...
                                <x-base.form-switch class="mt-3 w-full sm:ml-auto sm:mt-0 sm:w-auto">
                                    <x-base.form-switch.label class="ml-0 sm:ml-2" for="show-example-12">
                                        Show example code
                                    </x-base.form-switch.label>
                                    <x-base.form-switch.input class="ml-3 mr-0" id="show-example-12" type="checkbox" />
                                </x-base.form-switch>
                            </div>
                            <div>
