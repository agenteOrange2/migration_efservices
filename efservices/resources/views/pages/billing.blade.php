        ...
        <div class="col-span-12 flex flex-col gap-y-10 sm:col-span-10 sm:col-start-2">
                ...
                <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                        <x-base.button
                            ...
                            variant="primary">
                            <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="File" />
                            Download Excel
                        </x-base.button>
                    </div>
                </div>
                <div class="box box--stacked mt-3.5 p-5">
                    <div class="flex flex-col gap-y-8 rounded-lg border border-dashed bg-slate-50/60 p-5 lg:flex-row lg:items-center">
                        ...
                        <div class="lg:ml-auto">
                            <div class="flex flex-col gap-3 md:flex-row">
                                <x-base.button class="border-slate-300/80 bg-slate-100/70 px-4" variant="outline-secondary">
                                    <x-base.lucide class="-ml-0.5 mr-2 h-4 w-4 stroke-[1.3]" icon="ShieldX" />
                                    Cancel Subscription
                                </x-base.button>
                                <x-base.button class="border-primary/50 bg-primary/5 px-4" variant="outline-primary">
                                    <x-base.lucide class="-ml-0.5 mr-2 h-4 w-4 stroke-[1.3]" icon="AppWindow" />
                                    Update Plan
                                </x-base.button>
                            </div>
                        </div>
                ...
                <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                        <x-base.button variant="primary">
                            <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="MapPin" />
                            Add New Address
                        </x-base.button>
                    </div>
                </div>
                <div class="box box--stacked mt-3.5 p-5">
                    <div class="rounded-[0.6rem] border border-dashed border-slate-300/80">
                        @foreach ($users->take(3) as $fakerKey => $faker)
                            <div
                                ...
                                <x-base.form-check.input name="address" type="radio" value="billing-1" checked />
                                <div class="ml-5 flex w-full flex-col gap-y-3 sm:flex-row sm:items-center">
                                    ...
                                    <x-base.button class="whitespace-nowrap pl-3.5 pr-4 sm:ml-auto"
                                        variant="outline-secondary">
                                        <x-base.lucide class="mr-1.5 h-3.5 w-3.5 stroke-[1.3]" icon="PenSquare" />
                                        Edit Address
                                    </x-base.button>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="lg:ml-auto lg:text-right">
                            ...
                            <a class="mt-0.5 block text-primary" href="">
            ...
            <div>
                <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                        <x-base.button variant="primary">
                            <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="AppWindow" />
                            Add New Card
                        </x-base.button>
                    </div>
                </div>
                <div class="box box--stacked mt-3.5 p-5">
                    ...
                    <div class="mt-5 rounded-[0.6rem] border border-dashed border-slate-300/80">
                        <div
                            class="flex items-center border-b border-dashed border-slate-300/80 px-5 pb-4 pt-3 last:border-0 hover:bg-slate-50">
                            <x-base.form-check.input name="credit-card" type="radio" value="credit-card-1" checked />
                            <div class="ml-5 flex w-full flex-col sm:flex-row sm:items-center">
                                <svg class="h-14 w-14" xmlns="http://www.w3.org/2000/svg" width="400" height="130"
                                    viewBox="0 0 400 130" fill="none">
                                    <g>
                                        <path
                                ...
                                <div class="flex w-full flex-col gap-y-3 sm:ml-5 md:flex-row md:items-center">
                                    ...
                                    <div class="flex flex-col gap-3 sm:flex-row md:ml-auto">
                                        <x-base.button class="whitespace-nowrap pl-3.5 pr-4" variant="outline-secondary">
                                            <x-base.lucide class="mr-1.5 h-3.5 w-3.5 stroke-[1.3]" icon="PenSquare" />
                                            Edit
                                        </x-base.button>
                                        <x-base.button class="whitespace-nowrap pl-3.5 pr-4" variant="outline-secondary">
                                            <x-base.lucide class="mr-1.5 h-3.5 w-3.5 stroke-[1.3]" icon="Trash" />
                                            Delete
                                        </x-base.button>
                                    </div>
                                </div>
                        ...
                        <div
                            class="flex items-center border-b border-dashed border-slate-300/80 px-5 pb-4 pt-3 last:border-0 hover:bg-slate-50">
                            <x-base.form-check.input id="checkbox-switch-4" name="credit-card" type="radio"
                                value="credit-card-2" />
                            <div class="ml-5 flex w-full flex-col sm:flex-row sm:items-center">
                                <svg class="h-14 w-14" xmlns="http://www.w3.org/2000/svg" width="400" height="248"
                                    ...
                                    @foreach ($transactions->take(3) as $fakerKey => $faker)
                                        <x-base.table.tr class="[&_td]:last:border-b-0">
                                            ...
                                            <x-base.table.td class="border-dashed py-4 text-center">
                                                <x-base.button class="whitespace-nowrap pl-3.5 pr-4"
                                                    variant="outline-secondary">
                                                    <x-base.lucide class="mr-1.5 h-3.5 w-3.5 stroke-[1.3]"
                                                        icon="File" />
                                                    Download PDF
                                                </x-base.button>
                                            </x-base.table.td>
