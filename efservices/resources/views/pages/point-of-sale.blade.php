                        ...
                        <div class="box box--stacked flex flex-col p-5">
                            ...
                            >
                                <ol class="flex items-center text-theme-1">
                                    ...
                                    <li
                                        class="relative ml-5 pl-0.5 before:absolute before:inset-y-0 before:my-auto before:-ml-[1.125rem] before:h-[14px] before:w-[14px] before:rotate-[-90deg] before:transform before:bg-chevron-black before:bg-[length:100%] before:content-['']">
                                        <a href="/">Foods</a>
                                    </li>
                                    <li
                                        class="relative ml-5 cursor-text pl-0.5 text-slate-600 before:absolute before:inset-y-0 before:my-auto before:-ml-[1.125rem] before:h-[14px] before:w-[14px] before:rotate-[-90deg] before:transform before:bg-chevron-black before:bg-[length:100%] before:content-['']">
