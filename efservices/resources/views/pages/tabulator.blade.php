                    ...
                    <div class="flex flex-col gap-y-2 p-5 xl:flex-row xl:items-center">
                        <form
                            ...
                            <x-base.form-inline class="flex-col items-start gap-y-2 xl:flex-row xl:items-center">
                                ...
                                <x-base.form-select class="" id="tabulator-html-filter-field">
                            ...
                            <x-base.form-inline class="flex-col items-start gap-y-2 xl:flex-row xl:items-center">
                                ...
                                <x-base.form-select class="" id="tabulator-html-filter-type">
                            ...
                            <x-base.form-inline class="flex-col items-start gap-y-2 xl:flex-row xl:items-center">
                                ...
                                <x-base.form-input class="" id="tabulator-html-filter-value" type="text"
                                    placeholder="Search..." />
                            </x-base.form-inline>
                            <div class="mt-2 flex flex-col gap-2 sm:flex-row xl:mt-0">
                                <x-base.button class="w-full border-primary/20 bg-primary/5 sm:w-auto"
                                    id="tabulator-html-filter-go" type="button" variant="outline-primary">
                                    Search
                                </x-base.button>
                                <x-base.button class="w-full bg-slate-50/50 sm:w-auto" id="tabulator-html-filter-reset"
