                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            <div class="flex flex-col gap-2">
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-1/2" role="progressbar" aria-valuenow="0"
                                                        aria-valuemin="0" aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-2/3" role="progressbar" aria-valuenow="0"
                                                        aria-valuemin="0" aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-3/4" role="progressbar" aria-valuenow="0"
                                                        aria-valuemin="0" aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                            </div>
                                        </x-base.preview>
                                        <x-base.source>
                                            <x-base.highlight>
                                                <div class="flex flex-col gap-2">
                                                    <x-base.progress>
                                                        <x-base.progress.bar class="w-1/2" role="progressbar"
                                                            aria-valuenow="0" aria-valuemin="0"
                                                            aria-valuemax="100"></x-base.progress.bar>
                                                    </x-base.progress>
                                                    <x-base.progress>
                                                        <x-base.progress.bar class="w-2/3" role="progressbar"
                                                            aria-valuenow="0" aria-valuemin="0"
                                                            aria-valuemax="100"></x-base.progress.bar>
                                                    </x-base.progress>
                                                    <x-base.progress>
                                                        <x-base.progress.bar class="w-3/4" role="progressbar"
                                                            aria-valuenow="0" aria-valuemin="0"
                                                            aria-valuemax="100"></x-base.progress.bar>
                                                    </x-base.progress>
                                                </div>
                                    ...
                                    <div class="mt-4 flex flex-col gap-3.5 px-5 py-2">
                                        <x-base.preview>
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-2/3 bg-success" role="progressbar"
                                                        aria-valuenow="0" aria-valuemin="0"
                                                        aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-3/4 bg-warning" role="progressbar"
                                                        aria-valuenow="0" aria-valuemin="0"
                                                        aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                                <x-base.progress>
                                                    <x-base.progress.bar class="w-3/4 bg-danger" role="progressbar"
                                                        aria-valuenow="0" aria-valuemin="0"
                                                        aria-valuemax="100"></x-base.progress.bar>
                                                </x-base.progress>
                                            </div>
