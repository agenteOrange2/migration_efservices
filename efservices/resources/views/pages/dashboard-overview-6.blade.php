            ...
            <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                ...
                <div class="col-span-12 md:col-span-6 2xl:col-span-12">
                    ...
                    <div class="box box--stacked mt-3.5">
                        ...
                        <div class="px-5 py-6">
                            <x-base.button class="relative w-full justify-start border-primary/20 px-4 py-2.5"
                                href="" as="a" variant="outline-primary" rounded>
                                Explore Details
                                <div
                                    ...
                                    <x-base.table.tr class="[&_td]:last:border-b-0">
                                        ...
                                        <x-base.table.td
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex items-center">
                                                    <x-base.lucide class="mr-1 h-3.5 w-3.5 fill-pending/30 text-pending"
                                                        icon="Star" />
                                                    <x-base.lucide class="mr-1 h-3.5 w-3.5 fill-pending/30 text-pending"
                                                        icon="Star" />
                                                    <x-base.lucide class="mr-1 h-3.5 w-3.5 fill-pending/30 text-pending"
                                                    ...
                                                    <x-base.lucide class="mr-1 h-3.5 w-3.5 fill-pending/30 text-pending"
                                                        icon="Star" />
                                                    <x-base.lucide class="fill-slate/30 mr-1 h-3.5 w-3.5 text-slate-400"
                                                        icon="Star" />
                                                </div>
                                        ...
                                        <x-base.table.td
                                            class="rounded-l-none rounded-r-none border-x-0 border-t-0 border-dashed py-5 text-right first:rounded-l-[0.6rem] last:rounded-r-[0.6rem]">
                                            <a class="whitespace-nowrap font-medium" href="">
                                                {{ $faker['totalSales'] }}
                                            </a>
                                        </x-base.table.td>
                                        <x-base.table.td
                                            class="relative rounded-l-none rounded-r-none border-x-0 border-t-0 border-dashed py-5 first:rounded-l-[0.6rem] last:rounded-r-[0.6rem]">
                                            <div class="flex items-center justify-center">
                                                <x-base.menu class="h-5">
                                                    ...
                                                    <x-base.menu.items class="w-40">
                                                        <x-base.menu.item>
                                                            <x-base.lucide class="mr-2 h-4 w-4" icon="FileLineChart" />
                                                            Sales Report
                                                        </x-base.menu.item>
                                                        <x-base.menu.item>
                                                            <x-base.lucide class="mr-2 h-4 w-4" icon="FileCheck2" />
                                                            Item Details
                                                        </x-base.menu.item>
                                                    </x-base.menu.items>
                                                </x-base.menu>
