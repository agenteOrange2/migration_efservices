        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <x-base.button as="a" href="{{ route('driver.maintenance.index') }}"
            ...
            <div class="intro-y box p-5 mt-5">
                ...
                <form action="{{ route('driver.maintenance.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-base.form-input id="unit" name="unit" type="text"
                                ...
                                value="{{ old('unit', $vehicle->company_unit_number ?? '') }}" required />
                            @error('unit')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-base.form-input id="vendor_mechanic" name="vendor_mechanic" type="text"
                                ...
                                placeholder="e.g., ABC Auto Shop" value="{{ old('vendor_mechanic') }}" required />
                    ...
                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-base.litepicker id="next_service_date" name="next_service_date"
                                value="{{ old('next_service_date', now()->addMonths(3)->format('m/d/Y')) }}"
                    ...
                    <div class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <x-base.form-input id="cost" name="cost" type="number" step="0.01" min="0"
                                class="w-full @error('cost') border-danger @enderror" placeholder="0.00"
                        ...
                        <div>
                            ...
                            <x-base.form-input id="odometer" name="odometer" type="number" min="0"
                                class="w-full @error('odometer') border-danger @enderror" placeholder="Current mileage"
                    ...
                    <div class="mt-3">
                        ...
                        <x-base.form-textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Additional notes about this maintenance">{{ old('description') }}</x-base.form-textarea>
                        @error('description')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-5 p-4 bg-slate-50 dark:bg-darkmode-800 rounded-lg border border-slate-200/60">
                        ...
                        <p class="text-xs text-slate-500 mt-2 ml-6">Check this if the maintenance has already been
                            completed</p>
                    </div>
