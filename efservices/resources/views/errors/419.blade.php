...
<head>
    ...
    <title>419 - Sesión Expirada | {{ config('app.name', 'EFServices') }}</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            ...
            <!-- Error Code -->
            <div class="mb-6">
                <h1 class="text-6xl sm:text-7xl font-bold text-gray-900 mb-2">419</h1>
            ...
            <p class="text-gray-600 text-base sm:text-lg mb-8 leading-relaxed">
                Tu sesión ha expirado por inactividad. Por favor, actualiza la página o inicia sesión nuevamente para continuar.
            </p>
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="/login" 
                   class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors font-medium shadow-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
