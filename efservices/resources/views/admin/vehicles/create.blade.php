    ...
    <div class="box box--stacked p-8 mb-8">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 mb-2">Create New Vehicle</h1>
                    <p class="text-slate-600">Create a new vehicle</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div x-show="activeTab === 'general'">
                        <div>
                            ...
                            <div class="bg-white p-4 rounded-lg shadow">
                                <h3 class="text-lg font-semibold mb-4 text-gray-800 border-b pb-2">Vehicle Information
                                </h3>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-blue-700 mt-1">
                                                            Drivers can be assigned to this vehicle after creation using
                                                            the new assignment system.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="vin" x-model="vin" maxlength="17"
                                                        minlength="17" @input="validateVin()"
                                                        :class="{
                                                            'border-red-500': vinError,
                                                            'border-green-500': vin && vin
                                                                .length === 17 && !vinError
                                                        }"
                                                        class="py-2 px-3 block w-full border-gray-200 rounded-md text-sm"
                                                    ...
                                                    <p class="text-green-500 text-xs mt-1"
                                                        x-show="!vinError && vin && vin.length === 17">✓ Valid VIN
                                                        format</p>
                                                    <p class="text-gray-500 text-xs mt-1"
                                                        x-show="!vinError && (!vin || vin.length !== 17)">VIN must be
                                        ...
                                        <div class="mt-3 w-full flex-1 xl:mt-0">
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="gvwr" value="{{ old('gvwr') }}"
                                                        class="py-2 px-3 block w-full border-gray-200 rounded-md text-sm"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <x-base.litepicker name="registration_expiration_date"
                                                        value="{{ old('registration_expiration_date') }}"
                                        ...
                                        <div>
                                            ...
                                            <select name="status"
                                                ...
                                                <option value="out_of_service"
                                                    {{ old('status') == 'out_of_service' ? 'selected' : '' }}>Out of
                                                    Service</option>
                                            </select>
                                            @error('status')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
