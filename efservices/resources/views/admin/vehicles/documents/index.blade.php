...
@section('subcontent')
            ...
            <div class="box box--stacked p-8 mb-8">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-slate-800 mb-2">Vehicle Documents</h1>
                            <p class="text-slate-600">Vehicle Documents: {{ $vehicle->make }} {{ $vehicle->model }} ({{ $vehicle->year }})</p>
                        </div>
                    </div>
                    <div class="flex flex-col justify-center md:flex-row md:justify-end gap-3 w-full">
                        ...
                        @if($vehicle->documents->filter(fn($doc) => $doc->getFirstMedia('document_files') !== null)->count() > 0)
                        <x-base.button as="a" href="{{ route('admin.vehicles.documents.download-all', $vehicle->id) }}"
                            class="w-full sm:w-auto" variant="outline-success">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                ...
                                <div class="relative">
                                    ...
                                    <x-base.form-input class="rounded-[0.5rem] pl-9 sm:w-64" id="vehicle-search"
                                        type="text" placeholder="Search documents..." id="document-search" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box box--stacked">
                    <div class="box-header bg-slate-50 p-5 border-b border-slate-200/60">
                        <div class="flex flex-col gap-y-3 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <form action="{{ route('admin.vehicles.maintenances.generate-report', $vehicle->id) }}" method="POST" class="inline">
                                    @csrf
                    ...
                    <div class="box-body p-5">
                        ...
                        @if ($maintenanceReports->isEmpty())
                            <div class="text-center py-10">
                                ...
                                <div class="mt-2 text-sm text-slate-400">Click "Generate Maintenance Report" to create a report with all maintenance records for this vehicle.</div>
                            </div>
                        @else
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        @foreach ($maintenanceReports as $report)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                                ...
                                                <td class="text-center">
                                                    <div class="flex justify-center space-x-1 gap-2">
                                                        <a href="{{ route('admin.vehicles.documents.preview', [$vehicle->id, $report->id]) }}"
                                                            class="btn btn-primary btn-sm" target="_blank" title="Preview">
                                                            <x-base.lucide class="h-4 w-4" icon="Eye" />
                                                        </a>
                                                        <a href="{{ route('admin.vehicles.documents.download', [$vehicle->id, $report->id]) }}"
                ...
                <div class="box box--stacked">
                    <div class="box-header bg-slate-50 p-5 border-b border-slate-200/60">
                        <div class="flex flex-col gap-y-3 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <form action="{{ route('admin.vehicles.generate-repair-report', $vehicle->id) }}" method="POST" class="inline">
                                    @csrf
                                    <x-base.button type="submit" variant="primary" class="w-full sm:w-auto">
                                        <x-base.lucide class="mr-2 h-4 w-4" icon="FileText" />
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                                ...
                                                <td class="text-center">
                                                    <div class="flex justify-center space-x-1 gap-2">
                                                        ...
                                                        <form action="{{ route('admin.vehicles.delete-repair-report', [$vehicle->id, $report->id]) }}" method="POST" class="inline"
    ...
    <x-base.dialog id="add-document-modal" size="lg">
        <x-base.dialog.panel>
            ...
            <form action="{{ route('admin.vehicles.documents.store', $vehicle->id) }}" method="POST"
                ...
                <x-base.dialog.description>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="col-span-1">
                            ...
                            <x-base.litepicker id="issued_date" name="issued_date"
                ...
                <x-base.dialog.description>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="col-span-1">
                            ...
                            <x-base.litepicker id="edit_issued_date" name="issued_date"
                                placeholder="MM/DD/YYYY"
                                data-single-mode="true"
                                data-format="MM/DD/YYYY"
                                class="w-full" />
                        ...
                        <div class="col-span-1">
                            ...
                            <x-base.litepicker id="edit_expiration_date" name="expiration_date"
                                placeholder="MM/DD/YYYY"
                                data-single-mode="true"
                                data-format="MM/DD/YYYY"
                                class="w-full" />
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (editDocumentBtns.length > 0) {
                    editDocumentBtns.forEach(btn => {
                        btn.addEventListener('click', function() {
                            ...
                            form.action =
                                `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}`;
                            ...
                            // Convert dates from Y-m-d to MM/DD/YYYY format for Litepicker
                            ...
                            document.getElementById('edit_issued_date').value = formatDateForPicker(issuedDate);
                            document.getElementById('edit_expiration_date').value = formatDateForPicker(expirationDate);
                            ...
                            if (hasFile) {
                                ...
                                previewLink.href =
                                    `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}/preview`;
                                ...
                                downloadLink.href =
                                    `{{ route('admin.vehicles.documents.index', $vehicle->id) }}/${documentId}/download`;
                ...
                window.confirmDelete = function(vehicleId, documentId) {
                    ...
                    form.action = `{{ route('admin.vehicles.documents.destroy', [$vehicle->id, 'DOCUMENT_ID']) }}`
