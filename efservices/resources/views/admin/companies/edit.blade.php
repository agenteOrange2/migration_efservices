        ...
        <div class="box box--stacked p-8 mb-8">
            <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-slate-800 mb-2">Edit Company</h1>
                        <p class="text-slate-600">Edit company: {{ $company->company_name }}</p>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.companies.update', $company) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="contact" id="contact"
                                value="{{ old('contact', $company->contact ?? 'N/A') }}"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="email" name="email" id="email"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="phone" id="phone"
                                value="{{ old('phone', $company->phone ?? 'N/A') }}" placeholder="Enter phone number"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-base.form-input type="text" name="address" id="address"
                                value="{{ old('address', $company->address ?? 'N/A') }}"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="city" id="city"
                                value="{{ old('city', $company->city ?? 'N/A') }}" placeholder="Enter city"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="state" id="state"
                                value="{{ old('state', $company->state ?? 'N/A') }}" placeholder="Enter state"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="zip_code" id="zip_code"
                                value="{{ old('zip_code', $company->zip_code) }}" placeholder="Enter ZIP code"
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" name="country" id="country"
                                value="{{ old('country', $company->country ?? 'United States') }}"
