...
<div class="box box--stacked p-8 mb-8">
    <div class="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <x-base.button as="a" href="{{ route('admin.drivers.migration.wizard', $driver->id) }}" variant="warning" class="gap-2">
                <x-base.lucide class="w-4 h-4" icon="Truck" />
                Migrate to Another Carrier
            </x-base.button>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="col-span-12 lg:col-span-12">
        ...
        <div class="box box--stacked flex flex-col p-2 md:p-6 mt-6">
            <div class="flex items-center gap-3 mb-6">
    ...
    <div class="box box--stacked p-6 mt-6">
        ...
        @php
            $filteredHosDocuments = $hosDocuments->filter(function($doc) {
                return $doc->collection_name !== 'trip_reports';
            });
        @endphp

        @if($filteredHosDocuments->count() > 0)
        <div class="overflow-x-auto">
            <table class="table table-hover w-full">
                ...
                <tbody>
                    @foreach($filteredHosDocuments as $document)
            ...
            <div class="p-5">
                ...
                <form action="{{ route('admin.hos.documents.monthly-summary') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5">
                        <div>
                            <x-base.form-label for="hos_month">Month</x-base.form-label>
                            <x-base.form-select id="hos_month" name="month" required>
                                @for($m = 1; $m <= 12; $m++)
                        ...
                        <div>
                            <x-base.form-label for="hos_year">Year</x-base.form-label>
                            <x-base.form-select id="hos_year" name="year" required>
        ...
        <x-base.dialog.panel>
            <div class="p-5">
                ...
                <form action="{{ route('admin.hos.documents.document-monthly') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-5">
                        <div>
                            <x-base.form-label for="fmcsa_hos_month">Month</x-base.form-label>
                        ...
                        <div>
                            <x-base.form-label for="fmcsa_hos_year">Year</x-base.form-label>
    ...
    <script>
        ...
        function updateHosSelectedCount() {
            ...
            const countElement = document.getElementById('hos-selected-count');
            const selectAllCheckbox = document.getElementById('hos-select-all');
            ...
            const allCheckboxes = document.querySelectorAll('.hos-doc-checkbox');
        ...
        function bulkDownloadHos() {
            ...
            form.submit();
            // Don't remove form immediately for download - let it complete
        }

        function bulkDeleteHos() {
            console.log('bulkDeleteHos called');
            const checkboxes = document.querySelectorAll('.hos-doc-checkbox:checked');
