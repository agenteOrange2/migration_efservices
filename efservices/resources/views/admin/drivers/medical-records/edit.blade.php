    ...
    <div>
        ...
        <div class="box box--stacked p-8 mb-8">
            <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-slate-800 mb-2">Edit Medical Record</h1>
                        <p class="text-slate-600">Edit medical record: {{ $medicalRecord->social_security_number }}</p>
                    </div>
                </div>
        ...
        <div class="box box--stacked mt-5">
            <div class="box-body p-5">
                <form id="medicalRecordForm" action="{{ route('admin.medical-records.update', $medicalRecord) }}"
                                ...
                                <x-base.form-select id="carrier_id" name="carrier_id"
                                    ...
                                    @foreach ($carriers as $carrier)
                                        <option value="{{ $carrier->id }}"
                                            {{ old('carrier_id', $medicalRecord->userDriverDetail->carrier_id ?? '') == $carrier->id ? 'selected' : '' }}>
                                            {{ $carrier->name }}
                                        </option>
                                    @endforeach
                                </x-base.form-select>
                                ...
                                <x-base.form-select id="user_driver_detail_id" name="user_driver_detail_id"
                                    ...
                                    @foreach ($drivers as $driver)
                                        <option value="{{ $driver->id }}"
                                            {{ old('user_driver_detail_id', $medicalRecord->user_driver_detail_id) == $driver->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-base.form-input type="text" id="social_security_number" name="social_security_number"
                                    ...
                                    value="{{ old('social_security_number', $medicalRecord->social_security_number) }}"
                                    placeholder="XXX-XX-XXXX" pattern="\d{3}-\d{2}-\d{4}" x-mask="999-99-9999" required />
                            ...
                            <div>
                                ...
                                <x-base.litepicker id="hire_date" name="hire_date"
                                    value="{{ old('hire_date', $medicalRecord->hire_date ? $medicalRecord->hire_date->format('m/d/Y') : '') }}"
                            ...
                            <div>
                                ...
                                <x-base.form-input type="text" id="location" name="location"
                                    ...
                                    value="{{ old('location', $medicalRecord->location) }}" placeholder="Work location" />
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div x-data="{ isSuspended: {{ json_encode(old('is_suspended', $medicalRecord->is_suspended)) }} }">
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="is_suspended" name="is_suspended" value="1"
                                        x-model="isSuspended"
                                        {{ old('is_suspended', $medicalRecord->is_suspended) ? 'checked' : '' }}
                                ...
                                <div x-show="isSuspended" class="mt-3">
                                    ...
                                    <x-base.litepicker id="suspension_date" name="suspension_date"
                                        value="{{ old('suspension_date', $medicalRecord->suspension_date ? $medicalRecord->suspension_date->format('m/d/Y') : '') }}"
                                        class="@error('suspension_date') @enderror" placeholder="MM/DD/YYYY" />
                            ...
                            <div x-data="{ isTerminated: {{ json_encode(old('is_terminated', $medicalRecord->is_terminated)) }} }">
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" id="is_terminated" name="is_terminated" value="1"
                                        x-model="isTerminated"
                                        {{ old('is_terminated', $medicalRecord->is_terminated) ? 'checked' : '' }}
                                        class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div x-show="isTerminated" class="mt-3">
                                    ...
                                    <x-base.litepicker id="termination_date" name="termination_date"
                                        value="{{ old('termination_date', $medicalRecord->termination_date ? $medicalRecord->termination_date->format('m/d/Y') : '') }}"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-base.form-input type="text" id="medical_examiner_name" name="medical_examiner_name"
                                    ...
                                    value="{{ old('medical_examiner_name', $medicalRecord->medical_examiner_name) }}"
                                    required />
                            ...
                            <div>
                                ...
                                <x-base.form-input type="text" id="medical_examiner_registry_number"
                                    ...
                                    value="{{ old('medical_examiner_registry_number', $medicalRecord->medical_examiner_registry_number) }}"
                                    required />
                            ...
                            <div>
                                ...
                                <x-base.litepicker id="medical_card_expiration_date" name="medical_card_expiration_date"
                                    value="{{ old('medical_card_expiration_date', $medicalRecord->medical_card_expiration_date ? $medicalRecord->medical_card_expiration_date->format('m/d/Y') : '') }}"
                    ...
                    <div class="mb-8">
                            ...
                            <div class="mb-6">
                                <div class="flex items-center mb-3">
                                    @php
                                        ...
                                        $isPdf =
                                            $medicalCardMedia && $medicalCardMedia->mime_type === 'application/pdf';
                                    @endphp
                                    <x-base.lucide class="mr-2 h-5 w-5 text-slate-600"
                                        icon="{{ $isPdf ? 'file-text' : 'image' }}" />
                                ...
                                <div class="relative group max-w-md">
                                    @if ($isPdf)
                                        <!-- PDF Display -->
                                        <div
                                            class="aspect-[3/2] overflow-hidden rounded-lg border border-slate-200 bg-slate-50 flex items-center justify-center">
                                            <div class="text-center">
                                                <x-base.lucide class="mx-auto h-16 w-16 text-red-500 mb-2"
                                                    icon="file-text" />
                                                <p class="text-sm font-medium text-slate-700">PDF Document</p>
                                                <p class="text-xs text-slate-500">
                                                    {{ $medicalCardMedia->file_name ?? 'medical_card.pdf' }}</p>
                                            </div>
                                        </div>
                                    @else
                                        <!-- Image Display -->
                                        <div
                                            ...
                                            <img src="{{ $medicalCardImage }}" alt="Medical Card"
                                    ...
                                    <div
                                        ...
                                        <x-base.button as="a" href="{{ $medicalCardImage }}" target="_blank"
                        ...
                        @else
                            ...
                            <div class="flex items-center justify-center py-8 mb-6">
                                <div class="text-center">
                                    ...
                                    <p class="mt-1 text-xs text-slate-500">Upload a medical card image or PDF for
                                        verification.</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <x-base.form-label for="medical_card"
                                    class="form-label">{{ $medicalCardImage ? 'Replace Medical Card' : 'Upload Medical Card' }}</x-base.form-label>
