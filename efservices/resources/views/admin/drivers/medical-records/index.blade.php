...
<div class="container-fluid">
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-600">Manage driver medical records database</p>
                </div>
            </div>
    ...
    <div class="box box--stacked flex flex-col p-5">
        <div class="grid grid-cols-4 gap-5">
            <!-- Total Records Card -->
            <a href="{{ route('admin.medical-records.index', ['tab' => 'all'] + request()->except('tab', 'page')) }}"
            ...
            <!-- Active Records Card -->
            <a href="{{ route('admin.medical-records.index', ['tab' => 'active'] + request()->except('tab', 'page')) }}"
                class="box col-span-4 rounded-[0.6rem] border border-dashed relative
            ...
            <!-- Expiring Soon Card -->
            <a href="{{ route('admin.medical-records.index', ['tab' => 'expiring'] + request()->except('tab', 'page')) }}"
                class="box col-span-4 rounded-[0.6rem] border border-dashed relative
            ...
            <!-- Expired Card -->
            <a href="{{ route('admin.medical-records.index', ['tab' => 'expired'] + request()->except('tab', 'page')) }}"
                class="box col-span-4 rounded-[0.6rem] border border-dashed relative
    ...
    <div class="box box--stacked mt-5 p-3">
        ...
        <div class="box-body p-5">
            <form action="{{ route('admin.medical-records.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                            ...
                            <x-base.table.td class="whitespace-nowrap">
                                <x-base.menu>
                                    ...
                                    <x-base.menu.items class="w-48">
                                        ...
                                        @endif
                                        <x-base.menu.item as="a" href="{{ route('admin.medical-records.contact', $record) }}">
