            ...
            <div class="relative col-span-12 xl:col-span-3">
                <div class="sticky top-[104px]">
                    <div class="box box--stacked flex flex-col px-5 pb-6 pt-5">
                        <a href="{{ route('admin.settings', ['page' => 'profile-info']) }}" @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> is_null(request()->query('page')),
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="AppWindow" />
                            Profile Info
                        </a>
                        <a href="{{ route('admin.settings', ['page' => 'email-settings']) }}"
                            @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'email-settings',
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="MailCheck" />
                            Email Settings
                        </a>
                        <a href="{{ route('admin.settings', ['page' => 'security']) }}" @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'security',
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="KeyRound" />
                            Security
                        </a>                        
                        <a href="{{ route('admin.settings', ['page' => 'two-factor-authentication']) }}"
                            @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'two-factor-authentication',
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="ShieldCheck" />
                            Two-factor Authentication
                        </a>
                        <a href="{{ route('admin.settings', ['page' => 'device-history']) }}"
                            @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'device-history',
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="Smartphone" />
                            Device History
                        </a>
                        <a href="{{ route('admin.settings', ['page' => 'notification-settings']) }}"
                            @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'notification-settings',
                            ])>
                            <x-base.lucide class="mr-3 h-4 w-4 stroke-[1.3]" icon="BellDot" />
                            Notification Settings
                        </a>
                        <a href="{{ route('admin.settings', ['page' => 'account-deactivation']) }}"
                            @class([ 'flex items-center py-3 first:-mt-3 last:-mb-3 [&.active]:text-primary [&.active]:font-medium hover:text-primary' , 'active'=> request()->query('page') === 'account-deactivation',
                            ])>
            ...
            <div class="col-span-12 flex flex-col gap-y-7 xl:col-span-9">
                <div class="box box--stacked flex flex-col p-1.5">
                    <div class="relative h-60 w-full rounded-[0.6rem] bg-gradient-to-b from-theme-1/95 to-theme-2/95">
                        <div @class([ 'w-full h-full relative overflow-hidden' , "before:content-[''] before:absolute before:inset-0 before:bg-texture-white before:-mt-[50rem]" , "after:content-[''] after:absolute after:inset-0 after:bg-texture-white after:-mt-[50rem]" ,
                            ])></div>
                ...
                @include('admin.settings.partials.profile-info')
                </div>
                
                @elseif($currentPage === 'email-settings')
                <div class="box box--stacked flex flex-col p-5">                    
                @include('admin.settings.partials.email-settings')                
                </div>
                ...
                @elseif($currentPage === 'two-factor-authentication')
                <div class="box box--stacked flex flex-col p-5">                    
                @include('admin.settings.partials.two-factor-authentication')
                </div>

                @elseif($currentPage === 'device-history')
                <div class="box box--stacked flex flex-col p-5">                    
                @include('admin.settings.partials.device-history')
                </div>

                @elseif($currentPage === 'notification-settings')
                <div class="box box--stacked flex flex-col p-5">                    
                @include('admin.settings.partials.notification-settings')
                </div>

                @elseif($currentPage === 'account-deactivation')
                <div class="box box--stacked flex flex-col p-5">                    
                @include('admin.settings.partials.account-deactivation')
                </div>
