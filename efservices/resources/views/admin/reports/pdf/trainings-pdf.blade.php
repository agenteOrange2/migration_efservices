...
<body>
    ...
    <div class="summary">
        ...
        <div class="card">
            ...
            <p class="completion-rate"><strong>Completion Rate:</strong> {{ $completionRate }}%</p>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $assignment->driver->carrier->name ?? 'N/A' }}</td>
                <td style="max-width: 200px;">{{ \Illuminate\Support\Str::limit($assignment->training->title ?? 'N/A', 50) }}</td>
                ...
                <td>{{ $assignment->completed_date ? $assignment->completed_date->format('m/d/Y') : '-' }}</td>
                <td>
