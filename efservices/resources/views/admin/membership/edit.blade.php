    ...
    <div class="box box--stacked p-8 mb-8">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-slate-800 mb-2">Edit Membership: <span>{{ $membership->name }}</span></h1>
                    <p class="text-slate-600">Edit membership: {{ $membership->name }}</p>
                </div>
            </div>
            <div class="flex flex-col justify-center md:flex-row md:justify-end gap-3 w-full">
                <x-base.button as="a" href="{{ route('admin.membership.index') }}" variant="primary">
                        ...
                        <div class="p-7">
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex items-center">
                                        <x-image-preview name="image_membership" id="image_membership_input"
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <x-base.form-textarea name="description" class="block w-full"
                                        placeholder="Enter description"
                                        id="description">{{ old('description', $membership->description) }}</x-base.form-textarea>
                                    @error('description')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <select id="pricing_type" name="pricing_type" x-model="pricingType"
                                            ...
                                            <option value="plan"
                                                {{ old('pricing_type', $membership->pricing_type) === 'plan' ? 'selected' : '' }}>
                                                Plan Pricing</option>
                                            <option value="individual"
                                                {{ old('pricing_type', $membership->pricing_type) === 'individual' ? 'selected' : '' }}>
                                    ...
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                        <div class="grid-cols-1 gap-2 sm:grid">
                                            <x-base.input-group>
                                                ...
                                                <x-base.form-input type="number" step="0.01" name="price"
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 w-full mt-3 xl:mt-0">
                                            <div class="grid-cols-1 gap-2 sm:grid">
                                                <x-base.input-group>
                                                    <x-base.input-group.text>$</x-base.input-group.text>
                                                    <x-base.form-input type="number" step="0.01" name="carrier_price"
                                                        id="carrier_price"
                                                        value="{{ old('carrier_price', $membership->carrier_price) }}"
                                                        placeholder="Price per carrier" />
                                                </x-base.input-group>
                                            </div>
                                            @error('carrier_price')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 w-full mt-3 xl:mt-0">
                                            <div class="grid-cols-1 gap-2 sm:grid">
                                                <x-base.input-group>
                                                    <x-base.input-group.text>$</x-base.input-group.text>
                                                    <x-base.form-input type="number" step="0.01" name="driver_price"
                                                        id="driver_price"
                                                        value="{{ old('driver_price', $membership->driver_price) }}"
                                                        placeholder="Price per driver" />
                                                </x-base.input-group>
                                            </div>
                                            @error('driver_price')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 w-full mt-3 xl:mt-0">
                                            <div class="grid-cols-1 gap-2 sm:grid">
                                                <x-base.input-group>
                                                    <x-base.input-group.text>$</x-base.input-group.text>
                                                    <x-base.form-input type="number" step="0.01" name="vehicle_price"
                                                        id="vehicle_price"
                                                        value="{{ old('vehicle_price', $membership->vehicle_price) }}"
                            ...
                            <!-- Status Toggle -->
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center"
                                x-data="{ isActive: {{ $membership->status ? 'true' : 'false' }} }">
                                <div class="mb-2 inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="status" id="status"
                                            ...
                                            value="1" x-bind:checked="isActive"
                            ...
                            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center"
                                x-data="{ showInRegister: {{ $membership->show_in_register ? 'true' : 'false' }} }">
                                <div class="mb-2 inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="show_in_register" id="show_in_register"
                                            class="transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:border-darkmode-800 dark:bg-darkmode-600 dark:focus:ring-slate-700 dark:focus:ring-opacity-50 w-[38px] h-[24px] p-px rounded-full relative before:w-[20px] before:h-[20px] before:shadow-[1px_1px_3px_rgba(0,0,0,0.25)] before:transition-[margin-left] before:duration-200 before:ease-in-out before:absolute before:inset-y-0 before:my-auto before:rounded-full before:dark:bg-darkmode-600 checked:bg-primary checked:border-primary checked:bg-none before:checked:ml-[14px] before:checked:bg-white"
                                            value="1" x-bind:checked="showInRegister"
                                            x-on:change="showInRegister = !showInRegister">
