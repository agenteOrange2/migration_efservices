{{-- resources/views/auth/user_driver/carrier_limit_error.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Carrier Limit Reached - EF Services</title>
        ...
        <main class="flex-grow container mx-auto px-4 py-8">
            <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6">
                    ...
                    <h2 class="text-2xl font-bold text-center text-gray-800 mb-4">Carrier Has Reached Driver Limit</h2>
                    
                    <p class="text-gray-600 text-center mb-6">
                        We're sorry, but the carrier you're trying to register with has reached its maximum number of drivers.
                    </p>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 mb-6">
                        ...
                        <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p class="text-blue-800 text-sm">
                                <span class="font-medium">Contact Information:</span> If you're interested in working with this carrier, 
                                please contact them directly to inquire about future opportunities.
                            </p>
                        </div>
                    </div>
                    @endif
