...
<div>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center justify-between mt-8">
        ...
        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
            ...
            <x-base.button as="a" href="{{ route('carrier.licenses.show', $license->id) }}" class="btn btn-outline-primary ml-2">
    ...
    <div class="box box--stacked mt-5">
        <div class="box-body p-5">
            <form id="licenseForm" action="{{ route('carrier.licenses.update', $license) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" id="license_number" name="license_number" class="form-control @error('license_number') is-invalid @enderror" value="{{ old('license_number', $license->license_number) }}" required />
                        ...
                        <div>
                            ...
                            <x-base.litepicker id="expiration_date" name="expiration_date" value="{{ old('expiration_date', $license->expiration_date ? \Carbon\Carbon::parse($license->expiration_date)->format('m/d/Y') : '') }}" placeholder="MM/DD/YYYY" required />
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <x-base.form-textarea id="restrictions" name="restrictions" class="form-control @error('restrictions') is-invalid @enderror" rows="3" placeholder="Enter any license restrictions">{{ old('restrictions', $license->restrictions) }}</x-base.form-textarea>
                            @error('restrictions')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mb-2">
                                <input id="is_primary" name="is_primary" type="checkbox" value="1" {{ old('is_primary', $license->is_primary) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div id="cdl_endorsements" class="hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
                                @php
                                    $endorsementCodes = $license->endorsements->pluck('code')->toArray();
                                @endphp
                                <div class="flex items-center">
                                    <input id="endorsement_n" name="endorsement_n" type="checkbox" value="1" {{ old('endorsement_n', in_array('N', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div class="flex items-center">
                                    <input id="endorsement_h" name="endorsement_h" type="checkbox" value="1" {{ old('endorsement_h', in_array('H', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div class="flex items-center">
                                    <input id="endorsement_x" name="endorsement_x" type="checkbox" value="1" {{ old('endorsement_x', in_array('X', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div class="flex items-center">
                                    <input id="endorsement_t" name="endorsement_t" type="checkbox" value="1" {{ old('endorsement_t', in_array('T', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div class="flex items-center">
                                    <input id="endorsement_p" name="endorsement_p" type="checkbox" value="1" {{ old('endorsement_p', in_array('P', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                                ...
                                <div class="flex items-center">
                                    <input id="endorsement_s" name="endorsement_s" type="checkbox" value="1" {{ old('endorsement_s', in_array('S', $endorsementCodes)) ? 'checked' : '' }}
                                    class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="relative inline-block">
                                    <img src="{{ $frontImage->getUrl() }}" alt="License Front" class="img-thumbnail border rounded" style="max-width: 200px; max-height: 150px;">
                                    <div class="mt-2">
                                        <a href="{{ route('carrier.licenses.doc.preview', $frontImage->id) }}" target="_blank" class="text-primary text-sm hover:underline">
                            ...
                            <small class="form-text text-muted">{{ $frontImage ? 'Upload a new image to replace the current one' : 'Upload the front side of the driver\'s license' }} (JPG, PNG, GIF - Max 2MB)</small>
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <p class="text-sm text-gray-600 mb-2">Current Image:</p>
                                <div class="relative inline-block">
                                    <img src="{{ $backImage->getUrl() }}" alt="License Back" class="img-thumbnail border rounded" style="max-width: 200px; max-height: 150px;">
                                    <div class="mt-2">
                                        <a href="{{ route('carrier.licenses.doc.preview', $backImage->id) }}" target="_blank" class="text-primary text-sm hover:underline">
                                            <x-base.lucide class="w-4 h-4 inline" icon="eye" /> View Full Size
                                        </a>
                                    </div>
                                </div>
                            ...
                            <small class="form-text text-muted">{{ $backImage ? 'Upload a new image to replace the current one' : 'Upload the back side of the driver\'s license' }} (JPG, PNG, GIF - Max 2MB)</small>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('carrier.licenses.doc.preview', $doc->id) }}" target="_blank" class="text-primary hover:text-primary-dark">
                                        <x-base.lucide class="w-5 h-5" icon="eye" />
                                    </a>
                                    <form action="{{ route('carrier.licenses.doc.delete', $doc->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this document?');">
                                        @csrf
                                        @method('DELETE')
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.confirmDeleteLicense = function() {
