    ...
    <div>
        ...
        <div class="box box--stacked mt-5">
            ...
            <div class="box-body p-5">
                <form action="{{ route('carrier.drivers.inspections.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <x-base.litepicker id="inspection_date" name="inspection_date" 
                                value="{{ old('inspection_date', date('Y-m-d')) }}" class="block w-full @error('inspection_date') border-danger @enderror" />
                        ...
                        <div>
                            ...
                            <select id="inspection_type" name="inspection_type"
                                ...
                                <option value="DOT Roadside" {{ old('inspection_type') == 'DOT Roadside' ? 'selected' : '' }}>DOT Roadside</option>
                                <option value="State Police" {{ old('inspection_type') == 'State Police' ? 'selected' : '' }}>State Police</option>
                                <option value="Annual DOT" {{ old('inspection_type') == 'Annual DOT' ? 'selected' : '' }}>Annual DOT</option>
                                <option value="Pre-trip" {{ old('inspection_type') == 'Pre-trip' ? 'selected' : '' }}>Pre-trip</option>
                                <option value="Post-trip" {{ old('inspection_type') == 'Post-trip' ? 'selected' : '' }}>Post-trip</option>
                                <option value="Border Crossing" {{ old('inspection_type') == 'Border Crossing' ? 'selected' : '' }}>Border Crossing</option>
                                <option value="Weigh Station" {{ old('inspection_type') == 'Weigh Station' ? 'selected' : '' }}>Weigh Station</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <select id="inspection_level" name="inspection_level"
                                ...
                                <option value="Level I" {{ old('inspection_level') == 'Level I' ? 'selected' : '' }}>Level I - Full Inspection</option>
                                <option value="Level II" {{ old('inspection_level') == 'Level II' ? 'selected' : '' }}>Level II - Walk-Around</option>
                                <option value="Level III" {{ old('inspection_level') == 'Level III' ? 'selected' : '' }}>Level III - Driver Only</option>
                                <option value="Level IV" {{ old('inspection_level') == 'Level IV' ? 'selected' : '' }}>Level IV - Special Inspection</option>
                                <option value="Level V" {{ old('inspection_level') == 'Level V' ? 'selected' : '' }}>Level V - Vehicle Only</option>
                                <option value="Level VI" {{ old('inspection_level') == 'Level VI' ? 'selected' : '' }}>Level VI - Hazmat Inspection</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select id="status" name="status"
                                ...
                                <option value="Conditional Pass" {{ old('status') == 'Conditional Pass' ? 'selected' : '' }}>Conditional Pass</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <x-base.form-input id="location" name="location" type="text" 
                                value="{{ old('location') }}" class="block w-full" />
                            @error('location')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <label class="form-check mr-2 inline-block">
                                    <input id="vehicle_safe_yes" name="is_vehicle_safe_to_operate" type="radio" class="form-check-input" value="1" {{ old('is_vehicle_safe_to_operate', '1') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="mt-4">
                        ...
                        <x-base.form-textarea id="notes" name="notes" 
                            rows="4" class="block w-full">{{ old('notes') }}</x-base.form-textarea>
                        @error('notes')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
