    ...
    <div>
        ...
        <div class="box box--stacked mt-5">
            <div class="box-body p-5">
                <form action="{{ route('carrier.drivers.inspections.documents') }}" method="GET" id="filter-form"
                                ...
                                <div class="p-4">
                                    ...
                                    @if($driver)
                                        <div class="mb-2">
                                            ...
                                            <a href="{{ route('carrier.drivers.inspections.driver.documents', $driver) }}" class="text-sm text-blue-600 hover:underline">
                                                {{ $driver->user->name }} {{ $driver->last_name }}
                                            </a>
                                        </div>
                                    @endif
