...
<div>
    ...
    <div class="box box--stacked mt-5">
        <div class="box-body p-5">
            <form id="trainingSchoolForm" action="{{ route('carrier.training-schools.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <x-base.form-input type="text" id="school_name" name="school_name" class="form-control @error('school_name') is-invalid @enderror" value="{{ old('school_name') }}" placeholder="Enter training school name" required />
                            @error('school_name')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" id="city" name="city" class="form-control @error('city') is-invalid @enderror" value="{{ old('city') }}" placeholder="Enter city" required />
                            @error('city')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-base.form-input type="text" id="state" name="state" class="form-control @error('state') is-invalid @enderror" value="{{ old('state') }}" placeholder="Enter state" required />
                            @error('state')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-base.litepicker id="date_start" name="date_start" value="{{ old('date_start') }}" placeholder="MM/DD/YYYY" required />
                            @error('date_start')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-base.litepicker id="date_end" name="date_end" value="{{ old('date_end') }}" placeholder="MM/DD/YYYY" required />
                            @error('date_end')
                            <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            <div class="flex items-center">
                                <input id="graduated" name="graduated" type="checkbox" value="1" {{ old('graduated') ? 'checked' : '' }}
                        ...
                        <div>
                            <div class="flex items-center">
                                <input id="subject_to_safety_regulations" name="subject_to_safety_regulations" type="checkbox" value="1" {{ old('subject_to_safety_regulations') ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                <input id="performed_safety_functions" name="performed_safety_functions" type="checkbox" value="1" {{ old('performed_safety_functions') ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('double_trailer', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('passenger_vehicle', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('tank_vehicle', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('hazardous_materials', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('air_brakes', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('combination_vehicle', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('school_bus', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('flatbed', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                {{ is_array(old('training_skills')) && in_array('refrigerated', old('training_skills')) ? 'checked' : '' }}
                                class="form-checkbox h-4 w-4 text-primary border-gray-300 rounded" />
                ...
                <div class="mb-8">
                    <h4 class="text-lg font-semibold mb-4 text-gray-800 border-b pb-2">Training Documents</h4>
