    ...
    <div>
        ...
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            ...
            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                <x-base.button as="a" href="{{ route('carrier.medical-records.index') }}" variant="outline-secondary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="arrow-left" />
                    Back
                </x-base.button>
                <x-base.button as="a" href="{{ route('carrier.medical-records.edit', $medicalRecord->id) }}" variant="primary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="edit" />
                    Edit
                </x-base.button>
                <x-base.button as="a" href="{{ route('carrier.medical-records.docs.show', $medicalRecord->id) }}" variant="outline-primary">
            ...
            <div class="box box--stacked p-5">
                <div class="flex items-center justify-between border-b border-dashed border-slate-300/70 pb-5 mb-5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-base.button as="a" href="{{ route('carrier.medical-records.docs.show', $medicalRecord->id) }}" variant="outline-primary" size="sm">
                            View All Documents
                        </x-base.button>
                    </div>
                </div>
                ...
                <div id="uploadForm" style="display: none;" class="mb-5 p-4 bg-slate-50 rounded-lg border border-slate-200">
                    <form action="{{ route('carrier.medical-records.upload.documents', $medicalRecord->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                                    ...
                                    <x-base.table.tr class="intro-x">
                                        ...
                                        <x-base.table.td class="first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b]">
                                            <div class="flex items-center gap-2">
                                                <x-base.button
                                                    as="a"
                                                    href="{{ route('carrier.medical-records.doc.preview', $document->id) }}"
                                                    target="_blank"
        ...
        <script>
            function confirmDelete(documentId) {
                if (confirm('Are you sure you want to delete this document? This action cannot be undone.')) {
                    ...
                    form.method = 'POST';
                    form.action = `/carrier/medical-records/documents/${documentId}`;
