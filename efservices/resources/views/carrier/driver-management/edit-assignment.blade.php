    ...
    <div class="col-span-12">
        ...
        <div class="mt-5">
            <div class="box box--stacked flex flex-col">
                ...
                <form action="{{ route('carrier.driver-vehicle-management.update-assignment', $driver->id) }}" 
                      method="POST" 
                      class="p-5"
                      x-data="{ driverType: '' }"
                      x-init="driverType = '{{ old('driver_type', $currentAssignment->driver_type) }}'">
                    @csrf
                    @method('PUT')
