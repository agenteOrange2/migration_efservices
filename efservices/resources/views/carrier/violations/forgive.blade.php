...
@php
    $breadcrumbLinks = [
        ...
        ['label' => 'Details', 'url' => route('carrier.violations.show', $violation)],
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="box box--stacked p-6">
            ...
            <form action="{{ route('carrier.violations.forgive', $violation) }}" method="POST">
                @csrf
    ...
    <div class="space-y-6">
        ...
        <div class="box box--stacked p-6">
            ...
            <div class="space-y-3">
                ...
                @endif
                <a href="{{ route('carrier.trips.show', $violation->trip) }}" class="block mt-4">
