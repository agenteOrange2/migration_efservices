...
@php
    $breadcrumbLinks = [
        ...
        ['label' => 'Violations', 'url' => route('carrier.violations.index')],
    ...
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-3">
            @if(!$violation->acknowledged)
                <form action="{{ route('carrier.violations.acknowledge', $violation) }}" method="POST">
                    @csrf
            ...
            @if(!$violation->is_forgiven && $violation->has_penalty)
                <a href="{{ route('carrier.violations.forgive.form', $violation) }}">
            ...
            @endif
            <a href="{{ route('carrier.violations.index') }}">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="box box--stacked p-6">
            ...
            <div class="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                ...
                <a href="{{ route('carrier.trips.show', $violation->trip) }}">
    ...
    <div class="space-y-6">
        ...
        <div class="box box--stacked p-6">
            ...
            <a href="{{ route('carrier.drivers.show', $violation->driver) }}">
