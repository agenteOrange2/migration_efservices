                ...
                <div class="box p-5">
                    ...
                    <form id="filter-form" action="{{ route('carrier.maintenance.calendar') }}" method="GET">
                        ...
                        @if(isset($vehicleId) || isset($status))
                            <a href="{{ route('carrier.maintenance.calendar') }}" class="btn btn-secondary w-full mt-2">
                                Clear filters
                            </a>
                        @endif
                    </form>
                    ...
                    @if(isset($vehicleId) || isset($status))
                        <div class="mt-3 p-3 bg-blue-50 rounded-md text-sm">
                            ...
                            @if(isset($vehicleId))
                                <div class="text-blue-600">• Vehicle: {{ $vehicles->find($vehicleId)->make ?? '' }} {{ $vehicles->find($vehicleId)->model ?? '' }}</div>
                            @endif
                            @if(isset($status))
