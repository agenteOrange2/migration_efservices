...
<div>
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center justify-between mt-8">
        <div>
            ...
            <div class="text-slate-500 text-sm mt-1">
                View and manage messages with your drivers and admin
            </div>
        </div>
        <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <x-base.button as="a" href="{{ route('carrier.messages.dashboard') }}" variant="outline-primary" class="w-full sm:w-auto">
    ...
    <div class="box box--stacked mt-5 p-3">
        ...
        <div class="box-body p-5">
            <form action="{{ route('carrier.messages.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                ...
                <div class="lg:col-span-4 flex gap-2">
                    ...
                    <x-base.button as="a" href="{{ route('carrier.messages.index') }}" variant="outline-secondary">
                ...
                <x-base.table class="border-separate border-spacing-y-[10px]">
                    <x-base.table.thead>
                        <x-base.table.tr>
                            ...
                            <x-base.table.th class="whitespace-nowrap">From/To</x-base.table.th>
                        ...
                        <x-base.table.tr>
                            ...
                            <x-base.table.td class="px-6 py-4 first:rounded-l-md last:rounded-r-md bg-white border-b-0 dark:bg-darkmode-600 shadow-[20px_3px_20px_#0000000b] text-center">
                                <div class="flex justify-center items-center gap-2">
                                    <x-base.button as="a" href="{{ route('carrier.messages.show', $message) }}" variant="outline-primary" size="sm" title="View Message Details">
