            ...
            <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div class="flex flex-col w-full md:flex-row text-center md:text-left items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600">Monitor driver hours and compliance</p>
                    </div>
                </div>
                <div class="flex flex-col justify-center md:flex-row md:justify-end gap-3 w-full">
                    <x-base.button as="a" href="{{ route('carrier.hos.documents.index') }}" class="w-full sm:w-auto"
                        variant="outline-primary">
                        <x-base.lucide class="mr-2 h-4 w-4" icon="FileText" />
                        Documents
                    </x-base.button>
                    <x-base.button as="a" href="{{ route('carrier.hos.configuration') }}" class="w-full sm:w-auto"
                        variant="outline-secondary">
                        <x-base.lucide class="mr-2 h-4 w-4" icon="Settings" />
                        Configuration
                    </x-base.button>
                    <x-base.button as="a" href="{{ route('carrier.hos.violations') }}" class="w-full sm:w-auto"
        ...
        <div class="box box--stacked p-5 mb-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-sm text-slate-500">Current HOS Limits</div>
            ...
            <div class="box-body p-5">
                @if($driverSummaries->isEmpty())
                    <div class="text-center py-16">
                        ...
                        <p class="text-slate-500">No active drivers found for your carrier.</p>
                    </div>
                @else
                            ...
                            <tbody>
                                @foreach($driverSummaries as $summary)
                                    <tr class="border-b border-slate-200/60 hover:bg-slate-50 @if($summary['remaining']['is_driving_exceeded'] || $summary['remaining']['is_duty_exceeded']) bg-danger/5 @endif">
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            <a href="{{ route('carrier.hos.driver.log', $summary['driver']->id) }}" 
