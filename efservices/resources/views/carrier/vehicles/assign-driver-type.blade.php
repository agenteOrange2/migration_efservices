...
@php
    $breadcrumbLinks = [
        ...
        ['label' => 'Assign Driver', 'active' => true],
    ];
@endphp
@section('subcontent')
    <!-- Contenido principal -->
    <div class="box box--stacked mt-5">
        <div class="box-body p-5">
            <form id="assign-driver-form" action="{{ route('carrier.vehicles.store-driver-type', $vehicle->id) }}" method="POST" x-data="{ 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadDriverDataForPreview(driverId) {
            if (driverId && driverId !== 'unassigned') {
                ...
                const ajaxUrl = `{{ route('carrier.vehicles.get-driver-data', $vehicle->id) }}?driver_id=${driverId}`;
