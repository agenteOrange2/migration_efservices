    ...
    <div class="col-span-12">
        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
            ...
            <div class="flex flex-col gap-x-3 gap-y-6 sm:flex-row md:ml-auto">
                {{-- <a href="{{ route('carrier.vehicles.edit', $vehicle->id) }}" class="btn btn-primary flex align-middle">
                <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="PenLine" />
                Editar Vehículo
                </a> --}}
                {{-- <a href="{{ route('carrier.vehicles.maintenances.index', $vehicle->id) }}"
                class="btn btn-outline-secondary">
                <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="Tool" />
                Historial de Servicio
                </a> --}}
                <x-base.button as="a" href="{{ route('carrier.vehicles.edit', $vehicle->id) }}"
                    class="w-full sm:w-44" variant="primary">
                    <x-base.lucide class="mr-2 h-4 w-4 stroke-[1.3]" icon="PenLine" />
                    Edit Vehicle
                </x-base.button>

                <x-base.button as="a" href="{{ route('carrier.vehicles.documents.index', $vehicle->id) }}"
                    class="w-full sm:w-44" variant="primary">
                ...
                <x-base.button as="a" href="{{ route('carrier.vehicles.driver-assignment-history', $vehicle->id) }}"
                    class="w-full sm:w-56" variant="outline-primary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="Users" />
                    Driver History
                </x-base.button>

                <x-base.button as="a" href="{{ route('carrier.vehicles.assign-driver-type', $vehicle->id) }}"
                    class="w-full sm:w-44" variant="success">
...
<div class="mt-5">
    ...
    <div class="box box--stacked mt-5">
        ...
        <div class="box-body p-5">
            ...
            <div class="alert alert-success flex items-center mb-5 bg-green-50 border border-green-200 rounded-md p-4">
            ...
            <div class="alert alert-danger flex items-center mb-5 bg-red-50 border border-red-200 rounded-md p-4">
            ...
            <div class="alert alert-info flex items-center mb-5 bg-blue-50 border border-blue-200 rounded-md p-4">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-1">
                                    <a href="{{ route('carrier.maintenance.show', $item->id) }}"
                                        class="btn btn-sm btn-primary p-1" title="View details">
                                        <x-base.lucide class="h-4 w-4" icon="Eye" />
                                    </a>

                                    <form
                                        action="{{ route('carrier.maintenance.toggle-status', $item->id) }}"
                                    ...
                                    {{-- Notification feature not available for carrier yet
                                    @if (!$item->status && $item->isUpcoming())
                                    <form
                                        action="{{ route('carrier.maintenance-notifications.send-test') }}"
                                        method="POST" class="inline-block">
                                        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mt-5">
                ...
                <div class="box bg-slate-50 p-4 rounded">
                    <div class="text-xl font-medium text-success flex items-center">
                        <svg class="mr-2 h-8 w-8 stroke-[1.3]" fill="#0d9488" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#228000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                ...
                <div class="box bg-slate-50 p-4 rounded">
                    <div class="text-xl font-medium text-warning flex items-center">
                        <svg class="mr-2 h-8 w-8 stroke-[1.3]" viewBox="0 0 30 30" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#0d9488">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path class="st8" d="M15,4C8.9,4,4,8.9,4,15s4.9,11,11,11s11-4.9,11-11S21.1,4,15,4z M21.7,16.8c-0.1,0.4-0.5,0.6-0.9,0.5l-5.6-1.1 c-0.2,0-0.4-0.2-0.6-0.3C14.2,15.7,14,15.4,14,15c0,0,0,0,0,0l0.2-8c0-0.5,0.4-0.8,0.8-0.8c0.4,0,0.8,0.4,0.8,0.8l0.1,6.9l5.2,1.8 C21.6,15.8,21.8,16.3,21.7,16.8z"></path>
                            </g>
                        </svg>
                ...
                <div class="box bg-slate-50 p-4 rounded">
                    <div class="text-xl font-medium flex items-center">
                        <svg class="mr-2 h-8 w-8 stroke-[1.3]" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="dolarIconTitle" stroke="#03045E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none" color="#000000">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
...
<x-base.dialog id="add-service-modal" size="lg">
    <x-base.dialog.panel>
        ...
        <form action="{{ route('carrier.vehicles.maintenance.store', $vehicle->id) }}" method="POST"
            ...
            <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <x-base.litepicker id="service_date" name="service_date" value="{{ old('service_date') }}" class="py-2 px-3 block w-full border-gray-200 rounded-md text-sm @error('service_date') @enderror" placeholder="MM/DD/YYYY" />
                    @error('service_date')
                ...
                <div class="col-span-12 sm:col-span-6">
                    ...
                    <x-base.litepicker id="next_service_date" name="next_service_date" value="{{ old('next_service_date') }}" class="py-2 px-3 block w-full border-gray-200 rounded-md text-sm @error('next_service_date') @enderror" placeholder="MM/DD/YYYY" />
                    ...
                    <div x-data="{
                        ...
                        <div x-show="files.length > 0" class="mt-4">
                            ...
                            <div class="box_button_maintenance_services flex justify-between">
                                <div class="mt-2">
                                    <label class="relative flex items-center cursor-pointer btn btn-sm btn-outline-primary">
                                        <x-base.lucide class="mr-1 h-4 w-4" icon="Plus" /> Agregar más archivos
                                        <input type="file" class="sr-only" multiple @change="handleFileSelect"
                                            name="maintenance_files[]">
                                    </label>
                                </div>
                                <button type="button" @click="files = []" class="flex items-center btn btn-sm btn-outline-secondary mt-2">
                ...
                <div class="col-span-12">
                    <div class="form-check">
                        <input type="checkbox" id="status" name="status" value="1"
                            class="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary" x-model="serviceStatus">
