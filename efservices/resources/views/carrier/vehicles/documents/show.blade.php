...
$breadcrumbLinks = [
    ...
    ['label' => 'Documents', 'url' => route('carrier.vehicles.documents.index', $vehicle->id)],
                ...
                <div class="box-header p-5 border-b border-slate-200/60 bg-slate-50">
                    <div class="flex items-center">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="{{ route('carrier.vehicles.documents.index', $vehicle->id) }}"
                                class="btn btn-outline-secondary">
                                <x-base.lucide class="mr-2 h-4 w-4" icon="ArrowLeft" />
                                Back to Documents
                            </a>
                            {{-- Documents Overview button commented out - route not yet implemented
                            <a href="{{ route('carrier.vehicles-documents.index') }}"
                ...
                <div class="box-body p-5">
                    ...
                    <div class="mt-8 pt-6 border-t border-slate-200/60">
                        ...
                        <div class="mt-4 flex justify-center">
                            <a href="{{ route('carrier.vehicles.show', $vehicle->id) }}" class="btn btn-outline-secondary">
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <div class="px-5 pb-8 text-center">
                    <form action="{{ route('carrier.vehicles.documents.destroy', [$vehicle->id, $document->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
        ...
        if (editDocumentBtns.length > 0) {
            editDocumentBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    form.action = `{{ route('carrier.vehicles.documents.update', [$vehicle->id, $document->id]) }}`;
                    ...
                    if (hasFile) {
                        ...
                        previewLink.href = `{{ route('carrier.vehicles.documents.preview', [$vehicle->id, $document->id]) }}`;
                        ...
                        downloadLink.href = `{{ route('carrier.vehicles.documents.download', [$vehicle->id, $document->id]) }}`;
