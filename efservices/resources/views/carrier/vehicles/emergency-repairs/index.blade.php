        ...
        <div class="col-span-12">
            ...
            <div class="box box--stacked p-8 mb-8">
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-[300px]">
                        <x-base.button as="a" href="{{ route('carrier.emergency-repairs.create') }}" variant="primary">
                            <x-base.lucide class="w-4 h-4 mr-2" icon="plus" />
                            New Repairs Management
                        </x-base.button>
                    </div>
                </div>
            </div>
            ...
            <div class="box box--stacked flex flex-col p-5">
                <div class="grid grid-cols-4 gap-5">
                    <!-- Total Repairs Card -->
                    <a href="{{ route('carrier.emergency-repairs.index', ['tab' => 'all'] + request()->except('tab', 'page')) }}"
                    ...
                    <a href="{{ route('carrier.emergency-repairs.index', ['tab' => 'pending'] + request()->except('tab', 'page')) }}"
                       class="box col-span-4 rounded-[0.6rem] border border-dashed relative
                    ...
                    <a href="{{ route('carrier.emergency-repairs.index', ['tab' => 'in_progress'] + request()->except('tab', 'page')) }}"
                       class="box col-span-4 rounded-[0.6rem] border border-dashed relative
                    ...
                    <a href="{{ route('carrier.emergency-repairs.index', ['tab' => 'completed'] + request()->except('tab', 'page')) }}"
                       class="box col-span-4 rounded-[0.6rem] border border-dashed relative
            ...
            <div class="intro-y box p-5 mt-5">
                ...
                <form method="GET" action="{{ route('carrier.emergency-repairs.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <!-- Search -->
                    <div>
            ...
            <div class="box box--stacked mt-5 p-3">
                ...
                <div class="box-body p-0">
                                    ...
                                    <x-base.table.td class="whitespace-nowrap">
                                        <x-base.menu>
                                            ...
                                            <x-base.menu.items class="w-48">
                                                <x-base.menu.item as="a" href="{{ route('carrier.emergency-repairs.show', $repair) }}">
                                                    <x-base.lucide class="w-4 h-4 mr-2" icon="eye" />
                                                    View Details
                                                </x-base.menu.item>
                                                <x-base.menu.item as="a" href="{{ route('carrier.emergency-repairs.edit', $repair) }}">
                                                    <x-base.lucide class="w-4 h-4 mr-2" icon="edit" />
                                                    Edit
                                                </x-base.menu.item>
                                                <x-base.menu.divider />
                                                <x-base.menu.item>
                                                    <form action="{{ route('carrier.emergency-repairs.destroy', $repair) }}" method="POST"
                                                        onsubmit="return confirm('Are you sure you want to delete this repair?')" class="w-full">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="flex flex-col items-center justify-center py-16">
                        ...
                        <h3 class="text-lg font-medium text-slate-500 mb-2">No Repairs Management found</h3>
                        <p class="text-slate-400 mb-6 text-center max-w-md">
                            No Repairs Management match your current filters. Try adjusting your search criteria or create a new Repairs Management.
                        </p>
                        <x-base.button as="a" href="{{ route('carrier.emergency-repairs.create') }}" variant="primary">
                            <x-base.lucide class="w-4 h-4 mr-2" icon="plus" />
