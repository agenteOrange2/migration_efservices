            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <div class="mt-2 text-sm text-warning">
                        <p>You have pending documents to complete. Please upload all required documents to access all
                            platform features and ensure compliance.</p>
                    </div>
                    <div class="mt-4">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12">
            <h2 class="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                <x-base.lucide class="w-5 h-5 text-primary" icon="BarChart3" />
                Overview
            </h2>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                <!-- Card 1: Drivers - Con gradiente destacado -->
                <div
                    class="box relative overflow-hidden rounded-[0.6rem] border-0 bg-gradient-to-b from-theme-2/90 to-theme-1/[0.85] p-5 shadow-sm before:absolute before:right-0 before:top-0 before:-mr-[62%] before:h-[130%] before:w-full before:rotate-45 before:bg-gradient-to-b before:from-black/[0.15] before:to-transparent before:content-['']">
                    <div class="relative z-10">
                        ...
                        <div class="mt-12 flex items-center">
                            ...
                            @if ($this->membershipLimits['maxDrivers'] > 0)
                                <div
                                    class="ml-3.5 flex items-center rounded-full border border-white/30 bg-white/20 py-[2px] pl-[7px] pr-1 text-xs font-medium text-white">
                ...
                <!-- Card 2: Vehicles -->
                <div
                    class="box relative overflow-hidden rounded-[0.6rem] border border-slate-200/60 bg-white p-5 shadow-sm transition-all hover:shadow-md">
                    <div
                    ...
                    <div class="mt-12 flex items-center">
                        ...
                        @if ($this->membershipLimits['maxVehicles'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-primary/30 bg-primary/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-primary">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">{{ $documentStats['approved'] }}
                        </div>
                        @if ($documentStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-success/30 bg-success/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-success">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">{{ $documentStats['pending'] }}
                        </div>
                        @if ($documentStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-warning/30 bg-warning/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-warning">
        ...
        @if ($carrier->dot_number)
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                ...
                <div
                    class="box box--stacked overflow-hidden rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div class="flex flex-col md:flex-row">
                        <!-- Imagen -->
                        <div
                            class="relative h-48 md:h-auto md:w-64 bg-gradient-to-br from-primary via-primary/90 to-primary/80 flex items-center justify-center overflow-hidden">
                            @if ($carrier->hasSafetyDataSystemImage())
                                <img src="{{ $carrier->getSafetyDataSystemImageUrl() }}" alt="Safety Data System"
                            ...
                            <div class="flex flex-col h-full justify-between">
                                <div>
                                    <div class="flex items-start justify-between mb-3">
                                        <div>
                                            <h3 class="text-xl font-bold text-slate-800 mb-1">{{ $carrier->name }}
                                            </h3>
                                            <p class="text-sm text-slate-500">Federal Motor Carrier Safety
                                                Administration</p>
                                        </div>
                                        <div class="flex items-center gap-2 px-3 py-1.5 bg-primary/10 rounded-full">
                                            ...
                                            <span class="text-sm font-semibold text-primary">DOT:
                                                {{ $carrier->dot_number }}</span>
                                        </div>
                                    </div>

                                    <div class="bg-blue-50/50 rounded-lg p-3 border border-blue-100 mb-4">
                                        <p class="text-xs text-blue-600 mb-1 font-medium">Safety Monitoring System</p>
                                        <p class="text-xs text-slate-600">Check the safety and compliance status of
                                            your carrier in the FMCSA database.</p>
                                    </div>
                                </div>

                                <div>
                                    <x-base.button as="a" href="{{ $carrier->safety_data_system_url }}"
                                        target="_blank" variant="primary" class="w-full gap-2 justify-center">
                                        <x-base.lucide class="w-4 h-4" icon="ExternalLink" />
                                        Consulting Safety Data
                                    </x-base.button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-span-12 lg:col-span-4 xl:col-span-3">
            ...
            <div class="space-y-3">
                <a href="{{ route('carrier.drivers.create') }}" class="block">
                    <div class="box box--stacked p-4 hover:shadow-md transition-all group">
                        <div class="flex items-center gap-3">
                            <div class="p-2 bg-primary/10 rounded-lg group-hover:bg-primary/20 transition-colors">
                                <x-base.lucide class="w-5 h-5 text-primary" icon="UserPlus" />
                            </div>
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-slate-800">Add Driver</p>
                                <p class="text-xs text-slate-500">Register new driver</p>
                            </div>
                ...
                <a href="{{ route('carrier.vehicles.create') }}" class="block">
                    <div class="box box--stacked p-4 hover:shadow-md transition-all group">
                        <div class="flex items-center gap-3">
                            <div class="p-2 bg-info/10 rounded-lg group-hover:bg-info/20 transition-colors">
                                <x-base.lucide class="w-5 h-5 text-info" icon="Plus" />
                            </div>
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-slate-800">Add Vehicle</p>
                                <p class="text-xs text-slate-500">Register new vehicle</p>
                            </div>
                            <x-base.lucide class="w-4 h-4 text-slate-400" icon="ChevronRight" />
                        </div>
                    </div>
                ...
                <a href="{{ route('carrier.documents.index', $carrier->slug) }}" class="block">
                    <div class="box box--stacked p-4 hover:shadow-md transition-all group">
                        <div class="flex items-center gap-3">
                            <div class="p-2 bg-success/10 rounded-lg group-hover:bg-success/20 transition-colors">
                                <x-base.lucide class="w-5 h-5 text-success" icon="Upload" />
                            </div>
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-slate-800">Upload Documents</p>
                                <p class="text-xs text-slate-500">Manage documents</p>
                            </div>
                            <x-base.lucide class="w-4 h-4 text-slate-400" icon="ChevronRight" />
                        </div>
                    </div>
        ...
        <!-- ============================ -->
        <!-- SECCIÓN 4: MEDICAL RECORDS -->
        <!-- ============================ -->
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center mb-4">
                <h2 class="text-lg font-semibold text-slate-800 flex items-center gap-2">
                    <x-base.lucide class="w-5 h-5 text-primary" icon="Stethoscope" />
                    Medical Records Overview
                </h2>
                <a href="{{ route('carrier.medical-records.index') }}"
                    class="md:ml-auto text-sm font-medium text-primary hover:text-primary/80 transition-colors">View
            ...
            <div class="mt-3.5 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">
                            {{ $medicalRecordsStats['total'] }}</div>
                    </div>
                    <div class="mt-1 text-base text-slate-500">
                        Total Medical Records
                    </div>
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">
                            {{ $medicalRecordsStats['active'] }}</div>
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">
                            {{ $medicalRecordsStats['expiring_soon'] }}</div>
                        @if ($medicalRecordsStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-warning/30 bg-warning/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-warning">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">
                            {{ $medicalRecordsStats['expired'] }}</div>
                        @if ($medicalRecordsStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-danger/30 bg-danger/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-danger">
        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center mb-4">
                <h2 class="text-lg font-semibold text-slate-800 flex items-center gap-2">
                    ...
                    Driver Licenses Overview
                </h2>
                <a href="{{ route('carrier.licenses.index') }}"
                    class="md:ml-auto text-sm font-medium text-primary hover:text-primary/80 transition-colors">View
                    All Licenses</a>
            </div>
            <div class="mt-3.5 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">{{ $licenseStats['total'] }}
                        </div>
                    </div>
                    <div class="mt-1 text-base text-slate-500">
                        Total Licenses
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">{{ $licenseStats['valid'] }}
                        </div>
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">
                            {{ $licenseStats['expiring_soon'] }}</div>
                        @if ($licenseStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-warning/30 bg-warning/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-warning">
                ...
                <div
                    ...
                    <div class="mt-12 flex items-center">
                        <div class="text-2xl font-medium leading-none text-slate-800">{{ $licenseStats['expired'] }}
                        </div>
                        @if ($licenseStats['total'] > 0)
                            <div
                                class="ml-3.5 flex items-center rounded-full border border-danger/30 bg-danger/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-danger">
        ...
        <div class="col-span-12 lg:col-span-8">
                ...
                <div class="box box--stacked mt-3.5 p-5">
                                ...
                                <div>
                                    <div
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="text-base sm:text-lg font-semibold text-slate-800">{{ $driversCount }}
                                                / {{ $this->membershipLimits['maxDrivers'] }}</span>
                                            <span
                                                class="text-xs font-medium text-success bg-success/10 px-2 py-1 rounded-full">
                                                {{ $this->membershipLimits['driversPercentage'] }}%
                                            </span>
                                        </div>
                                    </div>
                                    <div class="relative h-3 w-full rounded-full bg-slate-200 overflow-hidden">
                                        <div class="h-full rounded-full bg-success transition-all duration-500 ease-out"
                            ...
                            @if ($this->membershipLimits['maxVehicles'] > 0)
                                <div>
                                    <div
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="text-base sm:text-lg font-semibold text-slate-800">{{ $vehiclesCount }}
                                                / {{ $this->membershipLimits['maxVehicles'] }}</span>
                                            <span
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center text-slate-500 py-8">
                            ...
                            <p class="text-xs mt-1 text-center">You don't have an active membership plan with limits
                            </p>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table w-full text-left">
                            <thead>
                                <tr>
                                    <th
                                        class="border-b-2 border-slate-200/60 pb-3 font-medium text-slate-600 whitespace-nowrap">
                                        Driver</th>
                                    <th
                                        class="border-b-2 border-slate-200/60 pb-3 font-medium text-slate-600 whitespace-nowrap">
                                        Status</th>
                                    <th
                                        class="border-b-2 border-slate-200/60 pb-3 font-medium text-slate-600 whitespace-nowrap text-right">
                                        Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="font-medium text-slate-800">
                                                        {{ trim($driver->user->name . ' ' . ($driver->last_name ?? '')) }}
                                                    </div>
                                                    <div class="text-slate-500 text-xs mt-0.5">
                                                        {{ $driver->user->email }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="border-b border-slate-200/60 py-4">
                                        ...
                                        <td class="border-b border-slate-200/60 py-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ route('carrier.drivers.show', $driver) }}"
                                                    class="flex items-center justify-center h-8 w-8 rounded-md text-slate-500 hover:bg-slate-100 hover:text-primary transition-colors"
                                                    title="Ver detalles">
                                                    <x-base.lucide class="h-4 w-4" icon="Eye" />
                                                </a>
                                                <a href="{{ route('carrier.drivers.edit', $driver) }}"
                                                    class="flex items-center justify-center h-8 w-8 rounded-md text-slate-500 hover:bg-slate-100 hover:text-primary transition-colors"
                                                    title="Editar">
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center border-b border-slate-200/60 py-8">
                                            <div class="flex flex-col items-center justify-center text-slate-500">
                                                ...
                                                <p class="text-xs mt-1">Recent drivers will appear here</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
            ...
            <div>
                <div class="flex flex-col gap-y-3 my-6 md:h-10 md:flex-row md:items-center">
                    <div class="text-base font-medium">Recent Documents</div>
                    <a href="{{ route('carrier.documents.index', $carrier) }}"
                        class="md:ml-auto text-sm font-medium text-primary hover:text-primary/80 transition-colors">View
                        All</a>
                </div>
                <div class="box box--stacked mt-3.5 p-5">
                            ...
                            <tbody>
                                @forelse($recentDocuments as $document)
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        <td class="border-b border-slate-200/60 py-4">
                                            <div class="font-medium text-slate-800">
                                                {{ $document->filename ?: 'Documento #' . $document->id }}</div>
                                        </td>
                                        <td class="border-b border-slate-200/60 py-4">
                                        ...
                                        <td class="border-b border-slate-200/60 py-4">
                                            <span
                                                class="text-slate-600 text-sm">{{ $document->date ? $document->date->format('m/d/Y') : $document->created_at->format('m/d/Y') }}</span>
                                        </td>
                                        <td class="border-b border-slate-200/60 py-4">
                                        ...
                                        <td class="border-b border-slate-200/60 py-4 text-right">
                                            ...
                                            @if ($documentUrl)
                                                <a href="{{ $documentUrl }}" target="_blank"
                                                    class="flex items-center justify-center h-8 w-8 rounded-md text-slate-500 hover:bg-slate-100 hover:text-primary transition-colors ml-auto"
                                                    title="Ver documento">
                                                    <x-base.lucide class="h-4 w-4" icon="ExternalLink" />
                                                </a>
                                            @else
                                                <span
                                                    class="flex items-center justify-center h-8 w-8 rounded-md text-slate-300 ml-auto"
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center border-b border-slate-200/60 py-8">
                                            <div class="flex flex-col items-center justify-center text-slate-500">
                                                ...
                                                <p class="text-xs mt-1">Recent documents will appear here</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
                ...
                <div class="box box--stacked mt-3.5 p-5">
                            ...
                            @foreach ($documentStatusCounts as $status => $count)
                                @php
                                    $percentage =
                                        $documentStats['total'] > 0
                                            ? round(($count / $documentStats['total']) * 100, 1)
                                            : 0;
                                ...
                                <div>
                                    <div
                                        class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                                        <div class="flex items-center">
                                            <x-base.lucide class="h-4 w-4 mr-2 text-{{ $colorClass }}"
                                                icon="{{ $icon }}" />
                                            <span class="text-slate-600 font-medium">{{ $status }}</span>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="text-base sm:text-lg font-semibold text-slate-800">{{ $count }}</span>
                                            <span
                                                class="text-xs font-medium text-{{ $colorClass }} bg-{{ $colorClass }}/10 px-2 py-1 rounded-full">
                                                {{ $percentage }}%
                                            </span>
                                        </div>
                                    </div>
                                    <div class="relative h-3 w-full rounded-full bg-slate-200 overflow-hidden">
                                        <div class="h-full rounded-full bg-{{ $colorClass }} transition-all duration-500 ease-out"
                        ...
                        <div class="mt-6 pt-6 border-t border-dashed border-slate-300/70">
                            ...
                            <div class="flex flex-col gap-3">
                                @forelse($documentTypeCounts as $type => $count)
                                    <div
                                        class="flex items-center justify-between rounded-lg bg-slate-50 px-3 py-2.5 transition-colors hover:bg-slate-100">
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center text-slate-500 py-8">
                            ...
                            <p class="text-xs mt-1 text-center">Documents and their status will appear here once you
                                begin uploading them</p>
                            <a href="{{ route('carrier.documents.index', $carrier) }}"
        ...
        <div class="col-span-12 flex flex-col gap-y-10 lg:col-span-4 xl:col-span-4">
            ...
            <div>
                ...
                <div class="box box--stacked mt-3.5 p-5">
                    ...
                    <div
                        class="mb-5 flex flex-col items-center gap-y-3 border-b border-dashed border-slate-300/70 pb-5">
                        <!-- Logo del carrier -->
                        <div
                            class="image-fit h-20 w-20 overflow-hidden rounded-full border-4 border-slate-200/70 shadow-sm">
                            <img src="{{ $carrier->getFirstMediaUrl('logo_carrier') ?: asset('build/default_company.png') }}"
                                alt="{{ $carrier->name }}" class="h-full w-full object-cover">
                        </div>
                        ...
                        <div class="text-center w-full">
                            ...
                            <div
                                class="mt-1 text-xs sm:text-sm text-slate-500 flex items-center justify-center flex-wrap gap-1 px-2">
                        ...
                        @if ($carrier->status === \App\Models\Carrier::STATUS_ACTIVE)
                            <div
                                class="flex items-center rounded-full border border-success/20 bg-success/10 px-4 py-1.5 font-medium text-success">
                                <x-base.lucide class="h-4 w-4 mr-2" icon="CheckCircle" />
                                <span>{{ $carrier->statusName }}</span>
                            </div>
                        @elseif(
                            $carrier->status === \App\Models\Carrier::STATUS_PENDING ||
                                $carrier->status === \App\Models\Carrier::STATUS_PENDING_VALIDATION)
                            <div
                                class="flex items-center rounded-full border border-warning/20 bg-warning/10 px-4 py-1.5 font-medium text-warning">
                                <x-base.lucide class="h-4 w-4 mr-2" icon="Clock" />
                                <span>{{ $carrier->statusName }}</span>
                            </div>
                        @elseif($carrier->status === \App\Models\Carrier::STATUS_REJECTED)
                            <div
                                class="flex items-center rounded-full border border-danger/20 bg-danger/10 px-4 py-1.5 font-medium text-danger">
                                <x-base.lucide class="h-4 w-4 mr-2" icon="XCircle" />
                                <span>{{ $carrier->statusName }}</span>
                            </div>
                        @else
                            <div
                                class="flex items-center rounded-full border border-slate-300/20 bg-slate-100 px-4 py-1.5 font-medium text-slate-600">
                    ...
                    <div class="flex justify-center border-t border-dashed border-slate-300/70 pt-5">
                        <a href="{{ route('carrier.profile.edit') }}"
