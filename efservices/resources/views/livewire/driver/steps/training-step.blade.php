                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block text-sm font-medium mb-1">Start Date <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="training_schools.{{ $index }}.date_start"
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">End Date <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="training_schools.{{ $index }}.date_end"
                                        ...
                                        <div class="border rounded-md p-2 relative flex flex-col">
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div class="flex-1 overflow-hidden">
                                                    <span
                                                        class="text-sm truncate block">{{ $token['filename'] }}</span>
                                                </div>
                                                <button type="button"
                                    ...
                                    @foreach ($school['certificates'] as $cert)
                                        <div class="border rounded-md p-2 relative flex flex-col">
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div class="flex-1 overflow-hidden">
                                                    <span
                                                        class="text-sm truncate block">{{ $cert['filename'] }}</span>
                                                </div>
                                                <button type="button"
    ...
    <div class="bg-white p-4 rounded-lg shadow mt-6">
        ...
        <div class="mb-6">
            <label class="inline-flex items-center cursor-pointer">
                ...
                <span class="ms-3 text-sm font-medium">Have you completed any professional courses or
                    certifications?</span>
            </label>
        </div>
                ...
                <div class="border p-4 rounded-lg mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="courses.{{ $index }}.certification_date"
                                value="{{ $course['certification_date'] ?? '' }}"
                                onchange="@this.set('courses.{{ $index }}.certification_date', this.value)"
                                class="driver-datepicker w-full px-3 py-2 border rounded" placeholder="MM/DD/YYYY" />
                        ...
                        <div>
                            ...
                            <input type="text" name="courses.{{ $index }}.expiration_date"
                    ...
                    @if (!empty($course['id']))
                        ...
                        <div class="mt-6 border-t border-slate-200/60 bg-slate-50" x-data="{}"
                            ...
                            @if (isset($course['certificates']) && count($course['certificates']) > 0)
                                <div class="flex justify-end mb-2">
                                    <button type="button"
                                        wire:click="clearAllCourseCertificates({{ $index }})"
                                        class="text-red-500 text-sm hover:text-red-700">
                                        <i class="fas fa-trash mr-1"></i> Eliminar todos los certificados
                                    </button>
                                </div>
