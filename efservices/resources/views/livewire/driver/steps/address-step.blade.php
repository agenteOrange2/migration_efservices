<div class="box box--stacked flex flex-col">
    ...
    <div class="p-4 sm:p-5">
        ...
        <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
            <div class="mb-3 sm:mb-2 inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                <div class="text-left sm:text-left xl:text-right">
                    <div class="flex items-center">
                        <div class="font-medium text-base">Current Address</div>
                    </div>
            ...
            <div class="mt-3 w-full flex-1 xl:mt-0">
                <div class="p-4 sm:p-5 border rounded-md bg-slate-50/50 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select wire:model="state"
                                class="form-select w-full rounded-md border border-slate-300/60 bg-white px-3 py-2 shadow-sm text-sm">
                    ...
                    <div class="flex items-start sm:items-center mt-4 gap-2">
                        <x-base.form-check.input class="mt-0.5 sm:mt-0 mr-0 sm:mr-2.5 border flex-shrink-0" type="checkbox" wire:model="lived_three_years" />
                        <span class="cursor-pointer select-none text-sm text-gray-700 leading-relaxed">
        ...
        <div x-show="!$wire.lived_three_years" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-start">
                <div class="mb-3 sm:mb-2 inline-block sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                    <div class="text-left sm:text-left xl:text-right">
                        <div class="flex items-center">
                            <div class="font-medium text-base">Previous Addresses</div>
                        </div>
                        <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                ...
                <div class="mt-3 w-full flex-1 xl:mt-0">
                    ...
                    @foreach ($previous_addresses as $index => $address)
                        <div class="p-4 sm:p-5 border rounded-md bg-slate-50/50 shadow-sm mb-4 sm:mb-5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="MM/DD/YYYY"
                                        class="driver-datepicker form-control w-full rounded-md border border-slate-300/60 px-3 py-2 shadow-sm"
                                        onchange="@this.set('previous_addresses.{{ $index }}.from_date', this.value)"
                                        required
                                    />
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="MM/DD/YYYY"
                                        class="driver-datepicker form-control w-full rounded-md border border-slate-300/60 px-3 py-2 shadow-sm"
                                        onchange="@this.set('previous_addresses.{{ $index }}.to_date', this.value)"
                                        required
                                    />
                    ...
                    <div class="mt-4">
                        <x-base.button type="button" wire:click="addPreviousAddress" class="w-full sm:w-auto sm:inline-block sm:w-64"
                            variant="primary">
        ...
        <!-- Navigation Buttons -->
        <div class="mt-6 sm:mt-8 px-4 sm:px-5 py-4 sm:py-5 border-t border-slate-200/60 dark:border-darkmode-400">
            <div class="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto order-1 sm:order-2">
