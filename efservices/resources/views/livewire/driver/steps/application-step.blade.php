                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label
                            ...
                            <input type="radio" wire:model="selectedDriverType" value="owner_operator"
                        ...
                        <label
                            class="flex items-center p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-blue-300 cursor-pointer transition-colors duration-200">
                            <input type="radio" wire:model="selectedDriverType" value="third_party"
                                class="mr-3 h-4 w-4 text-blue-600">
                            <div class="flex-1">
                        ...
                        <label
                            class="flex items-center p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-blue-300 cursor-pointer transition-colors duration-200">
                            <input type="radio" wire:model="selectedDriverType" value="company_driver"
                                class="mr-3 h-4 w-4 text-blue-600">
                            <div class="flex-1">
