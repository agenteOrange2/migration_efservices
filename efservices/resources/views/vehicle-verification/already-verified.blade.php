...
<head>
    ...
    <title>Vehicle Already Verified - EFCTS</title>
        ...
        <div class="max-w-4xl mx-auto px-4 py-8">
            <div class="flex items-center justify-between">
                ...
                <div class="bg-green-500/20 backdrop-blur-sm px-4 py-2 rounded-full border border-green-400/30">
                    <span class="text-green-100 font-semibold text-sm">✓ Verified</span>
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-12">
        <div class="max-w-lg w-full fade-in">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-10 text-center">
                <!-- Success Icon -->
                <div class="mx-auto w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center mb-8 success-pulse shadow-lg">
                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>
                    </svg>
                </div>
                
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Vehicle Already Verified</h2>
                <p class="text-gray-600 mb-8 text-lg leading-relaxed">
                    Great news! This vehicle has already been successfully verified and is approved for use on the EFCTS platform.
                </p>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 mb-8">
                    <div class="flex items-center justify-center mb-3">
                        ...
                        <h3 class="font-bold text-green-800 text-lg">Verification Complete</h3>
                    </div>
                    <p class="text-green-700 font-medium">
                        Your vehicle is ready for transportation services
                    </p>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
                    <div class="flex items-center justify-center mb-4">
                        ...
                        <h3 class="font-bold text-gray-800 text-lg">Need Assistance?</h3>
                    </div>
                ...
                <a href="/" class="inline-flex items-center justify-center w-full ef-gradient text-white px-8 py-4 rounded-xl hover:shadow-lg transition-all duration-200 font-semibold text-lg">
